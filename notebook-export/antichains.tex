...
\PY{n}{W} \PY{o}{=} \PY{p}{\PYZob{}}\PY{p}{\PYZcb{}}
\PY{n}{var}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{λ k n}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}

\PY{k}{for} \PY{n}{f} \PY{o+ow}{in} \PY{n+nb}{sorted}\PY{p}{(}\PY{n}{pathlib}\PY{o}{.}\PY{n}{Path}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{generated\PYZhy{}antichains}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{o}{.}\PY{n}{glob}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{*.txt}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{)}\PY{p}{:}
    \PY{n}{j} \PY{o}{=} \PY{n+nb}{int}\PY{p}{(}\PY{n}{f}\PY{o}{.}\PY{n}{name}\PY{p}{[}\PY{p}{:}\PY{o}{\PYZhy{}}\PY{l+m+mi}{4}\PY{p}{]}\PY{p}{)}
    \PY{n}{W}\PY{p}{[}\PY{n}{j}\PY{p}{]} \PY{o}{=} \PY{p}{[}\PY{n}{sage\PYZus{}eval}\PY{p}{(}\PY{n}{line}\PY{p}{,} \PY{n+nb}{locals}\PY{o}{=}\PY{p}{\PYZob{}}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{λ}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{n}{λ}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{k}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{n}{k}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{n}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{n}{n}\PY{p}{\PYZcb{}}\PY{p}{)}\PY{o}{.}\PY{n}{collect}\PY{p}{(}\PY{n}{binom}\PY{p}{)}
            \PY{k}{for} \PY{n}{line}\PY{p}{,} \PY{n}{binom} \PY{o+ow}{in} \PY{n+nb}{zip}\PY{p}{(}\PY{n}{f}\PY{o}{.}\PY{n}{read\PYZus{}text}\PY{p}{(}\PY{p}{)}\PY{o}{.}\PY{n}{strip}\PY{p}{(}\PY{p}{)}\PY{o}{.}\PY{n}{split}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+se}{\PYZbs{}n}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}\PY{p}{,}
                                   \PY{p}{[}\PY{n}{binomial}\PY{p}{(}\PY{n}{n}\PY{p}{,} \PY{n}{k}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{,} \PY{n}{binomial}\PY{p}{(}\PY{n}{n}\PY{p}{,} \PY{n}{k}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{]}\PY{p}{)}\PY{p}{]}
\end{Verbatim}
\end{tcolorbox}

    For example, the contribution coming from clusters \(\Gamma\) with
\(\lVert \Gamma \rVert = 2\) is the sum of the two lines below:

    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
\prompt{In}{incolor}{2}{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{display}\PY{p}{(}\PY{n}{W}\PY{p}{[}\PY{l+m+mi}{2}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}
\PY{n}{display}\PY{p}{(}\PY{n}{W}\PY{p}{[}\PY{l+m+mi}{2}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}

    $\displaystyle -\frac{1}{4} \, {\left(2 \, {\left(k - n - 1\right)} {\left(k - 1\right)} {\left(\frac{λ^{2}}{{\left(λ + 1\right)}^{-2 \, k + 2 \, n + 1}} - \frac{λ^{2}}{{\left(λ + 1\right)}^{-2 \, k + 2 \, n + 2}}\right)} + \frac{{\left(k^{2} - 2 \, k n + n^{2} - k + n\right)} λ^{2}}{{\left(λ + 1\right)}^{k + 1} {\left(λ + 1\right)}^{-k + n + 1}} + \frac{2 \, λ^{2}}{{\left(λ + 1\right)}^{-2 \, k + 2 \, n + 2}}\right)} \binom{n}{k - 1}$

    
    $\displaystyle -\frac{1}{4} \, {\left(2 \, {\left(k - n + 1\right)} {\left(k + 1\right)} {\left(\frac{λ^{2}}{{\left(λ + 1\right)}^{2 \, k + 1}} - \frac{λ^{2}}{{\left(λ + 1\right)}^{2 \, k + 2}}\right)} + \frac{{\left(k^{2} + k\right)} λ^{2}}{{\left(λ + 1\right)}^{k + 1} {\left(λ + 1\right)}^{-k + n + 1}} + \frac{2 \, λ^{2}}{{\left(λ + 1\right)}^{2 \, k + 2}}\right)} \binom{n}{k + 1}$

    
    The coefficients given by \texttt{w{[}j{]}(n,\ k,\ λ)} are valid for any
choice of \(2j < k < n-2j\). Let us do a minor sanity check of this
statement in the context of ``central layers'': * When \(n = 2m+1\),
there are two definitions for ``three central layers'': either layers
\(m-1\), \(m\) and \(m+1\), or layers \(m\), \(m+1\) and \(m+2\). Fixing
a root in layer \(m-1\) in the former should give exactly the same
contribution from fixing a vertex in layer \(m+2\) in the latter. * When
\(n = 2m\), the contribution from fixing a root in layer \(m-1\) should
equal the contribution from fixing a root in layer \(m+1\).

    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
\prompt{In}{incolor}{3}{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{var}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{m}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\PY{k}{for} \PY{n}{j}\PY{p}{,} \PY{p}{(}\PY{n}{kminus}\PY{p}{,} \PY{n}{kplus}\PY{p}{)} \PY{o+ow}{in} \PY{n}{W}\PY{o}{.}\PY{n}{items}\PY{p}{(}\PY{p}{)}\PY{p}{:}
    \PY{k}{if} \PY{n}{j} \PY{o}{\PYZlt{}}\PY{o}{=} \PY{l+m+mi}{5}\PY{p}{:} \PY{c+c1}{\PYZsh{} for performance}
        \PY{k}{assert} \PY{n+nb}{bool}\PY{p}{(}\PY{n}{kminus}\PY{o}{.}\PY{n}{subs}\PY{p}{(}\PY{n}{n} \PY{o}{==} \PY{l+m+mi}{2}\PY{o}{*}\PY{n}{m}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{)}\PY{o}{.}\PY{n}{subs}\PY{p}{(}\PY{n}{k} \PY{o}{==} \PY{n}{m}\PY{p}{)} \PY{o}{==} 
                    \PY{n}{kplus}\PY{o}{.}\PY{n}{subs}\PY{p}{(}\PY{n}{n} \PY{o}{==} \PY{l+m+mi}{2}\PY{o}{*}\PY{n}{m}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{)}\PY{o}{.}\PY{n}{subs}\PY{p}{(}\PY{n}{k} \PY{o}{==} \PY{n}{m}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{)}
        \PY{k}{assert} \PY{n+nb}{bool}\PY{p}{(}\PY{n}{kminus}\PY{o}{.}\PY{n}{subs}\PY{p}{(}\PY{n}{n} \PY{o}{==} \PY{l+m+mi}{2}\PY{o}{*}\PY{n}{m}  \PY{p}{)}\PY{o}{.}\PY{n}{subs}\PY{p}{(}\PY{n}{k} \PY{o}{==} \PY{n}{m}\PY{p}{)} \PY{o}{==} 
                    \PY{n}{kplus}\PY{o}{.}\PY{n}{subs}\PY{p}{(}\PY{n}{n} \PY{o}{==} \PY{l+m+mi}{2}\PY{o}{*}\PY{n}{m}  \PY{p}{)}\PY{o}{.}\PY{n}{subs}\PY{p}{(}\PY{n}{k} \PY{o}{==} \PY{n}{m}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}

    The \texttt{display\_table} function below has no mathematical content,
but it helps visualize the output later on. Ignore the following cell.

    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
\prompt{In}{incolor}{4}{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{k+kn}{import} \PY{n+nn}{collections}\PY{n+nn}{.}\PY{n+nn}{abc}
\PY{k+kn}{import} \PY{n+nn}{functools}

\PY{n}{EVEN}\PY{p}{,} \PY{n}{ODD} \PY{o}{=} \PY{p}{(}\PY{n}{k} \PY{o}{==} \PY{n}{n}\PY{o}{/}\PY{l+m+mi}{2}\PY{p}{)}\PY{p}{,} \PY{p}{(}\PY{n}{k} \PY{o}{==} \PY{p}{(}\PY{n}{n}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{)}\PY{o}{/}\PY{l+m+mi}{2}\PY{p}{)}

\PY{k}{def} \PY{n+nf}{clean}\PY{p}{(}\PY{n}{h}\PY{p}{,} \PY{n}{ex}\PY{p}{)}\PY{p}{:}
    \PY{k}{return} \PY{n}{ex}\PY{o}{.}\PY{n}{subs}\PY{p}{(}\PY{n}{h}\PY{p}{)}\PY{o}{.}\PY{n}{simplify\PYZus{}rational}\PY{p}{(}\PY{p}{)}

\PY{k}{def} \PY{n+nf}{display\PYZus{}table}\PY{p}{(}\PY{n}{limit}\PY{p}{,} \PY{n}{fn}\PY{p}{,} \PY{n}{fn\PYZus{}name}\PY{p}{,} \PY{n}{merge\PYZus{}even}\PY{o}{=}\PY{k}{lambda} \PY{n}{x}\PY{p}{:} \PY{n}{x}\PY{p}{)}\PY{p}{:}
    \PY{k+kn}{from} \PY{n+nn}{IPython}\PY{n+nn}{.}\PY{n+nn}{display} \PY{k+kn}{import} \PY{n}{Markdown}
    \PY{k}{for} \PY{n}{hyp}\PY{p}{,} \PY{n}{label}\PY{p}{,} \PY{n}{merge} \PY{o+ow}{in} \PY{p}{[}\PY{p}{(}\PY{n}{EVEN}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Even case}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{merge\PYZus{}even}\PY{p}{)}\PY{p}{,}
                              \PY{p}{(}\PY{n}{ODD}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Odd case}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{k}{lambda} \PY{n}{x}\PY{p}{:} \PY{n}{x}\PY{p}{)}\PY{p}{]}\PY{p}{:}
        \PY{n}{display}\PY{p}{(}\PY{n}{Markdown}\PY{p}{(}\PY{l+s+sa}{f}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{***}\PY{l+s+si}{\PYZob{}}\PY{n}{label}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s2}{***}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}\PY{p}{)}
        \PY{n}{results} \PY{o}{=} \PY{n}{fn}\PY{p}{(}\PY{n}{hyp}\PY{p}{)}
        \PY{k}{if} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{,}\PY{l+s+s2}{\PYZdq{}} \PY{o+ow}{not} \PY{o+ow}{in} \PY{n}{fn\PYZus{}name}\PY{p}{:}
            \PY{n}{results} \PY{o}{=} \PY{p}{[}\PY{n}{results}\PY{p}{]}
            
        \PY{k}{for} \PY{n}{out}\PY{p}{,} \PY{n}{lbl} \PY{o+ow}{in} \PY{n+nb}{zip}\PY{p}{(}\PY{n}{results}\PY{p}{,} \PY{n}{fn\PYZus{}name}\PY{o}{.}\PY{n}{split}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{,}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}\PY{p}{)}\PY{p}{:}
            \PY{k}{if} \PY{n+nb}{isinstance}\PY{p}{(}\PY{n}{out}\PY{p}{,} \PY{n+nb}{dict}\PY{p}{)}\PY{p}{:}
                \PY{k}{for} \PY{n}{j}\PY{p}{,} \PY{n}{val} \PY{o+ow}{in} \PY{n}{out}\PY{o}{.}\PY{n}{items}\PY{p}{(}\PY{p}{)}\PY{p}{:}
                    \PY{k}{if} \PY{n}{j} \PY{o}{\PYZlt{}}\PY{o}{=} \PY{n}{limit}\PY{p}{:}
                        \PY{n}{val} \PY{o}{=} \PY{n}{merge}\PY{p}{(}\PY{n}{val}\PY{p}{)}
                        \PY{k}{if} \PY{n+nb}{isinstance}\PY{p}{(}\PY{n}{val}\PY{p}{,} \PY{n+nb}{list}\PY{p}{)}\PY{p}{:}
                            \PY{k}{for} \PY{n}{idx}\PY{p}{,} \PY{n}{v} \PY{o+ow}{in} \PY{n+nb}{enumerate}\PY{p}{(}\PY{n}{val}\PY{p}{)}\PY{p}{:}
                                \PY{n}{display}\PY{p}{(}\PY{l+s+sa}{f}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+si}{\PYZob{}}\PY{n}{lbl}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s2}{\PYZca{}}\PY{l+s+si}{\PYZob{}}\PY{n}{idx}\PY{o}{+}\PY{l+m+mi}{1}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s2}{\PYZus{}}\PY{l+s+si}{\PYZob{}}\PY{n}{j}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s2}{ = }\PY{l+s+s2}{\PYZdq{}} \PY{o}{+} \PY{n}{latex}\PY{p}{(}\PY{n}{v}\PY{p}{)}\PY{p}{)}
                        \PY{k}{else}\PY{p}{:}
                            \PY{n}{display}\PY{p}{(}\PY{l+s+sa}{f}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+si}{\PYZob{}}\PY{n}{lbl}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s2}{\PYZus{}}\PY{l+s+si}{\PYZob{}}\PY{n}{j}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s2}{ = }\PY{l+s+s2}{\PYZdq{}} \PY{o}{+} \PY{n}{latex}\PY{p}{(}\PY{n}{val}\PY{p}{)}\PY{p}{)}
                        \PY{n}{display}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
            \PY{k}{else}\PY{p}{:}
                \PY{n}{display}\PY{p}{(}\PY{l+s+sa}{f}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+si}{\PYZob{}}\PY{n}{lbl}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s2}{ = }\PY{l+s+s2}{\PYZdq{}} \PY{o}{+} \PY{n}{latex}\PY{p}{(}\PY{n}{out}\PY{p}{)}\PY{p}{)}

\PY{c+c1}{\PYZsh{} https://wiki.python.org/moin/PythonDecoratorLibrary\PYZsh{}Memoize}
\PY{k}{class} \PY{n+nc}{memoized}\PY{p}{(}\PY{n+nb}{object}\PY{p}{)}\PY{p}{:}
   ...
   \PY{k}{def} \PY{n+nf+fm}{\PYZus{}\PYZus{}call\PYZus{}\PYZus{}}\PY{p}{(}\PY{n+nb+bp}{self}\PY{p}{,} \PY{o}{*}\PY{n}{args}\PY{p}{)}\PY{p}{:}
      \PY{k}{if} \PY{o+ow}{not} \PY{n+nb}{isinstance}\PY{p}{(}\PY{n}{args}\PY{p}{,} \PY{n}{collections}\PY{o}{.}\PY{n}{abc}\PY{o}{.}\PY{n}{Hashable}\PY{p}{)}\PY{p}{:}
         \PY{k}{return} \PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{func}\PY{p}{(}\PY{o}{*}\PY{n}{args}\PY{p}{)}
      \PY{k}{if} \PY{n}{args} \PY{o+ow}{in} \PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{cache}\PY{p}{:}
         \PY{k}{return} \PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{cache}\PY{p}{[}\PY{n}{args}\PY{p}{]}
      \PY{k}{else}\PY{p}{:}
         \PY{n}{value} \PY{o}{=} \PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{func}\PY{p}{(}\PY{o}{*}\PY{n}{args}\PY{p}{)}
         \PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{cache}\PY{p}{[}\PY{n}{args}\PY{p}{]} \PY{o}{=} \PY{n}{value}
         \PY{k}{return} \PY{n}{value}
   \PY{k}{def} \PY{n+nf+fm}{\PYZus{}\PYZus{}repr\PYZus{}\PYZus{}}\PY{p}{(}\PY{n+nb+bp}{self}\PY{p}{)}\PY{p}{:}
      \PY{k}{return} \PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{func}\PY{o}{.}\PY{n+nv+vm}{\PYZus{}\PYZus{}doc\PYZus{}\PYZus{}}
   \PY{k}{def} \PY{n+nf+fm}{\PYZus{}\PYZus{}get\PYZus{}\PYZus{}}\PY{p}{(}\PY{n+nb+bp}{self}\PY{p}{,} \PY{n}{obj}\PY{p}{,} \PY{n}{objtype}\PY{p}{)}\PY{p}{:}
      \PY{k}{return} \PY{n}{functools}\PY{o}{.}\PY{n}{partial}\PY{p}{(}\PY{n+nb+bp}{self}\PY{o}{.}\PY{n+nf+fm}{\PYZus{}\PYZus{}call\PYZus{}\PYZus{}}\PY{p}{,} \PY{n}{obj}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}

    \section{\texorpdfstring{Theorem 4.2: The polynomials \(S_j\) and
\(P_j\)}{Theorem 4.2: The polynomials S\_j and P\_j}}\label{theorem-4.2-the-polynomials-s_j-and-p_j}

    The main goal of this section is to obtain polynomials
\(S^{1}_j(n, \lambda)\) and \(S^{2}_j(n, \lambda)\). The paper does only
the odd case, noting that the ``case of \(n\) even is analogous (and
simpler)''. To accommodate for both cases, \(S^1\) and \(S^2\) will be
defined regardless of the parity of \(n\), although they are defined by
different formulas in the even and odd cases. Moreover,
\(S^{1}_j = S^{2}_j\) when \(n\) is even, and \(S^{0}_j\) in this case
is just \(S^{1}_j + S^{2}_j\).

We will choose \(k = \lceil n/2 \rceil\) to compute the \(S\)
polynomials.

Recall that the \(S^r_j\) are polynomials such that
\(\operatorname{deg}_n S^r_j \leq 2(j-1)\),
\(\operatorname{deg}_\lambda S^r_j \leq 2j^2\) and
...
Note that \(S^r_j\) is then just
\(W^r_j(n, k, \lambda) \cdot (1+\lambda)^{j(k+1)}\) for
\(k = \lceil n/2 \rceil\) (that is, \(k = n/2\) when \(n\) is even or
\(k = (n+1)/2\) when \(n\) is odd) divided by the appropriate binomial
(\(\binom{n}{k-1}\) or \(\binom{n}{k+1}\)).

    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
\prompt{In}{incolor}{5}{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n+nd}{@memoized}
\PY{k}{def} \PY{n+nf}{compute\PYZus{}S}\PY{p}{(}\PY{n}{h}\PY{p}{)}\PY{p}{:}
    \PY{n}{S} \PY{o}{=} \PY{p}{\PYZob{}}\PY{p}{\PYZcb{}}
    \PY{k}{for} \PY{n}{j} \PY{o+ow}{in} \PY{n}{W}\PY{o}{.}\PY{n}{keys}\PY{p}{(}\PY{p}{)}\PY{p}{:}
        \PY{n}{S}\PY{p}{[}\PY{n}{j}\PY{p}{]} \PY{o}{=} \PY{p}{[}\PY{n}{W}\PY{p}{[}\PY{n}{j}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]} \PY{o}{/} \PY{n}{binomial}\PY{p}{(}\PY{n}{n}\PY{p}{,} \PY{n}{k}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{,} \PY{n}{W}\PY{p}{[}\PY{n}{j}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]} \PY{o}{/} \PY{n}{binomial}\PY{p}{(}\PY{n}{n}\PY{p}{,} \PY{n}{k}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{]}
        \PY{n}{S}\PY{p}{[}\PY{n}{j}\PY{p}{]} \PY{o}{=} \PY{p}{[}\PY{n}{clean}\PY{p}{(}\PY{n}{h}\PY{p}{,} \PY{n}{ex} \PY{o}{*} \PY{p}{(}\PY{l+m+mi}{1}\PY{o}{+}\PY{n}{λ}\PY{p}{)}\PY{o}{\PYZca{}}\PY{p}{(}\PY{n}{j} \PY{o}{*} \PY{p}{(}\PY{n}{k}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{)}\PY{p}{)} \PY{k}{for} \PY{n}{ex} \PY{o+ow}{in} \PY{n}{S}\PY{p}{[}\PY{n}{j}\PY{p}{]}\PY{p}{]}
        \PY{k}{assert} \PY{n+nb}{all}\PY{p}{(}\PY{n}{QQ}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{λ}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{n}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{(}\PY{n}{poly}\PY{p}{)}\PY{o}{.}\PY{n}{degree}\PY{p}{(}\PY{p}{)} \PY{o}{\PYZlt{}}\PY{o}{=} \PY{l+m+mi}{2}\PY{o}{*}\PY{p}{(}\PY{n}{j}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{)} \PY{k}{for} \PY{n}{poly} \PY{o+ow}{in} \PY{n}{S}\PY{p}{[}\PY{n}{j}\PY{p}{]}\PY{p}{)}
        \PY{k}{assert} \PY{n+nb}{all}\PY{p}{(}\PY{n}{QQ}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{n}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{λ}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{(}\PY{n}{poly}\PY{p}{)}\PY{o}{.}\PY{n}{degree}\PY{p}{(}\PY{p}{)} \PY{o}{\PYZlt{}}\PY{o}{=} \PY{l+m+mi}{2}\PY{o}{*}\PY{n}{j}\PY{o}{\PYZca{}}\PY{l+m+mi}{2} \PY{k}{for} \PY{n}{poly} \PY{o+ow}{in} \PY{n}{S}\PY{p}{[}\PY{n}{j}\PY{p}{]}\PY{p}{)}
    \PY{k}{return} \PY{n}{S}

\PY{n}{display\PYZus{}table}\PY{p}{(}\PY{l+m+mi}{6}\PY{p}{,} \PY{n}{compute\PYZus{}S}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{S}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{merge\PYZus{}even}\PY{o}{=}\PY{n+nb}{sum}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\end{tcolorbox}
    ...
    $\displaystyle S_2 = \left(\frac{1}{4} λ^{3} - \frac{1}{8} λ^{2}\right) n^{2} - \frac{1}{4} λ^{2} n - λ^{3} - λ^{2}$

    
    $\displaystyle $

    
    $\displaystyle S_3 = \left(\frac{1}{16} λ^{5} - \frac{1}{16} λ^{4} + \frac{1}{64} λ^{3}\right) n^{4} + \left(\frac{1}{24} λ^{6} - \frac{1}{12} λ^{5} - \frac{1}{24} λ^{4} + \frac{1}{16} λ^{3}\right) n^{3} + \left(-\frac{5}{12} λ^{5} - \frac{1}{12} λ^{4} + \frac{3}{16} λ^{3}\right) n^{2} + \left(-\frac{1}{6} λ^{6} + \frac{1}{3} λ^{5} + \frac{1}{6} λ^{4} + \frac{1}{4} λ^{3}\right) n + \frac{2}{3} λ^{5} + \frac{4}{3} λ^{4} + \frac{2}{3} λ^{3}$
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{k}{def} \PY{n+nf}{compute\PYZus{}P}\PY{p}{(}\PY{n}{h}\PY{p}{)}\PY{p}{:}
    \PY{n}{S} \PY{o}{=} \PY{n}{compute\PYZus{}S}\PY{p}{(}\PY{n}{h}\PY{p}{)}
    \PY{n}{P} \PY{o}{=} \PY{p}{\PYZob{}}\PY{p}{\PYZcb{}}
    \PY{k}{for} \PY{n}{j} \PY{o+ow}{in} \PY{n}{S}\PY{o}{.}\PY{n}{keys}\PY{p}{(}\PY{p}{)}\PY{p}{:}
        \PY{n}{P}\PY{p}{[}\PY{n}{j}\PY{p}{]} \PY{o}{=} \PY{p}{[}\PY{p}{(}\PY{n}{p} \PY{o}{/} \PY{l+m+mi}{2}\PY{o}{\PYZca{}}\PY{n}{j}\PY{p}{)}\PY{o}{.}\PY{n}{subs}\PY{p}{(}\PY{n}{λ} \PY{o}{==} \PY{l+m+mi}{1}\PY{p}{)}\PY{o}{.}\PY{n}{simplify\PYZus{}rational}\PY{p}{(}\PY{p}{)} \PY{k}{for} \PY{n}{p} \PY{o+ow}{in} \PY{n}{S}\PY{p}{[}\PY{n}{j}\PY{p}{]}\PY{p}{]}
    \PY{k}{return} \PY{n}{P}

\PY{n}{display\PYZus{}table}\PY{p}{(}\PY{l+m+mi}{6}\PY{p}{,} \PY{n}{compute\PYZus{}P}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{P}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{merge\PYZus{}even}\PY{o}{=}\PY{n+nb}{sum}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{k}{def} \PY{n+nf}{compute\PYZus{}F}\PY{p}{(}\PY{n}{h}\PY{p}{)}\PY{p}{:}
    \PY{n}{S} \PY{o}{=} \PY{n}{compute\PYZus{}S}\PY{p}{(}\PY{n}{h}\PY{p}{)}
    \PY{n}{F} \PY{o}{=} \PY{p}{\PYZob{}}\PY{p}{\PYZcb{}}
    \PY{k}{for} \PY{n}{j} \PY{o+ow}{in} \PY{n}{S}\PY{o}{.}\PY{n}{keys}\PY{p}{(}\PY{p}{)}\PY{p}{:}
        \PY{n}{F}\PY{p}{[}\PY{n}{j}\PY{p}{]} \PY{o}{=} \PY{n}{clean}\PY{p}{(}\PY{n}{h}\PY{p}{,} \PY{n}{k}\PY{o}{*}\PY{p}{(}\PY{n}{k}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{)} \PY{o}{*} \PY{p}{(}\PY{p}{(}\PY{l+m+mi}{1}\PY{o}{+}\PY{n}{λ}\PY{p}{)} \PY{o}{*} \PY{n}{S}\PY{p}{[}\PY{n}{j}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{o}{.}\PY{n}{derivative}\PY{p}{(}\PY{n}{λ}\PY{p}{)} \PY{o}{\PYZhy{}} \PY{n}{j}\PY{o}{*}\PY{p}{(}\PY{n}{k}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{)}\PY{o}{*}\PY{n}{S}\PY{p}{[}\PY{n}{j}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)} \PY{o}{+}
                        \PY{p}{(}\PY{n}{n}\PY{o}{\PYZhy{}}\PY{n}{k}\PY{p}{)}\PY{o}{*}\PY{p}{(}\PY{n}{n}\PY{o}{\PYZhy{}}\PY{n}{k}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{)}\PY{o}{*}\PY{p}{(}\PY{p}{(}\PY{l+m+mi}{1}\PY{o}{+}\PY{n}{λ}\PY{p}{)}\PY{o}{*}\PY{n}{S}\PY{p}{[}\PY{n}{j}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{o}{.}\PY{n}{derivative}\PY{p}{(}\PY{n}{λ}\PY{p}{)} \PY{o}{\PYZhy{}} \PY{n}{j}\PY{o}{*}\PY{p}{(}\PY{n}{k}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{)}\PY{o}{*}\PY{n}{S}\PY{p}{[}\PY{n}{j}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}\PY{p}{)}
        \PY{k}{assert} \PY{n}{QQ}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{λ}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{n}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{(}\PY{n}{F}\PY{p}{[}\PY{n}{j}\PY{p}{]}\PY{p}{)}\PY{o}{.}\PY{n}{degree}\PY{p}{(}\PY{p}{)} \PY{o}{\PYZlt{}}\PY{o}{=} \PY{l+m+mi}{2}\PY{o}{*}\PY{n}{j}\PY{o}{+}\PY{l+m+mi}{1}
        \PY{k}{assert} \PY{n}{QQ}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{n}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{λ}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{(}\PY{n}{F}\PY{p}{[}\PY{n}{j}\PY{p}{]}\PY{p}{)}\PY{o}{.}\PY{n}{degree}\PY{p}{(}\PY{p}{)} \PY{o}{\PYZlt{}}\PY{o}{=} \PY{l+m+mi}{2}\PY{o}{*}\PY{n}{j}\PY{o}{\PYZca{}}\PY{l+m+mi}{2}
    \PY{k}{return} \PY{n}{F}

\PY{n}{display\PYZus{}table}\PY{p}{(}\PY{l+m+mi}{2}\PY{p}{,} \PY{n}{compute\PYZus{}F}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{F}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\[\lambda = \frac{\beta + X}{1-\beta}\] and let
\(\gamma = (1-\beta)^{k+1}\), we may expand
\((1-\lambda)^{-j(k+1)} = \gamma^j / (1+X)^{j(k+1)}\) as a function of
\(\gamma\) and \(X\) in the expression of Corollary 5.8 to obtain
...
The function \texttt{compute\_E} below returns such an expression of
\(\gamma\), \(\beta\) and \(X\).

    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
\prompt{In}{incolor}{9}{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{var}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{X β γ}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}

\PY{k}{def} \PY{n+nf}{compute\PYZus{}q}\PY{p}{(}\PY{n}{t}\PY{p}{)}\PY{p}{:}
    \PY{k}{return} \PY{p}{(}\PY{n}{t}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{)}\PY{o}{/}\PY{o}{/}\PY{l+m+mi}{2} \PY{o}{\PYZhy{}} \PY{l+m+mi}{1}

\PY{k}{def} \PY{n+nf}{compute\PYZus{}E}\PY{p}{(}\PY{n}{h}\PY{p}{,} \PY{n}{t}\PY{p}{)}\PY{p}{:}
    \PY{n}{F} \PY{o}{=} \PY{n}{compute\PYZus{}F}\PY{p}{(}\PY{n}{h}\PY{p}{)}    
    \PY{n}{q} \PY{o}{=} \PY{n}{compute\PYZus{}q}\PY{p}{(}\PY{n}{t}\PY{p}{)}
    \PY{k}{assert} \PY{n}{q} \PY{o+ow}{in} \PY{n}{F}

    \PY{c+c1}{\PYZsh{} E is the expectation of |A|}
    \PY{n}{E} \PY{o}{=} \PY{l+m+mi}{1}
    \PY{k}{for} \PY{n}{j} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,} \PY{n}{q}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{:}
        \PY{c+c1}{\PYZsh{} Expansion for (1+λ)\PYZca{}\PYZob{}\PYZhy{}j(k+1)\PYZcb{} by Newton\PYZsq{}s binomial theorem}
        \PY{n}{pow\PYZus{}lambda} \PY{o}{=} \PY{n}{γ}\PY{o}{\PYZca{}}\PY{n}{j} \PY{o}{*} \PY{n+nb}{sum}\PY{p}{(}\PY{p}{[}\PY{n}{binomial}\PY{p}{(}\PY{o}{\PYZhy{}}\PY{n}{j}\PY{o}{*}\PY{p}{(}\PY{n}{k}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{,} \PY{n}{i}\PY{p}{)} \PY{o}{*} \PY{n}{X}\PY{o}{\PYZca{}}\PY{n}{i} \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{q}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{]}\PY{p}{)}
        \PY{c+c1}{\PYZsh{} Sum the term corresponding to F[j]}
        \PY{n}{E} \PY{o}{+}\PY{o}{=} \PY{n}{pow\PYZus{}lambda} \PY{o}{*} \PY{n}{F}\PY{p}{[}\PY{n}{j}\PY{p}{]}\PY{o}{.}\PY{n}{subs}\PY{p}{(}\PY{n}{λ} \PY{o}{==} \PY{p}{(}\PY{n}{β} \PY{o}{+} \PY{n}{X}\PY{p}{)}\PY{o}{/}\PY{p}{(}\PY{l+m+mi}{1}\PY{o}{\PYZhy{}}\PY{n}{β}\PY{p}{)}\PY{p}{)}\PY{o}{/}\PY{p}{(}\PY{p}{(}\PY{n}{n}\PY{o}{\PYZhy{}}\PY{n}{k}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{)} \PY{o}{*} \PY{p}{(}\PY{n}{k}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{)}

    \PY{c+c1}{\PYZsh{} Now we mulitply by λ/(1+λ) expanded in terms of β and X}
    \PY{n}{E} \PY{o}{*}\PY{o}{=} \PY{p}{(}\PY{n}{β} \PY{o}{+} \PY{n}{X}\PY{p}{)} \PY{o}{*} \PY{n+nb}{sum}\PY{p}{(}\PY{p}{[}\PY{p}{(}\PY{o}{\PYZhy{}}\PY{n}{X}\PY{p}{)}\PY{o}{\PYZca{}}\PY{n}{i} \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{q}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{]}\PY{p}{)}
    \PY{n}{E} \PY{o}{=} \PY{n}{clean}\PY{p}{(}\PY{n}{h}\PY{p}{,} \PY{n}{E}\PY{p}{)}

    \PY{k}{return} \PY{n}{E}

\PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Taking t = 3 for the example}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\PY{n}{display\PYZus{}table}\PY{p}{(}\PY{l+m+mi}{2}\PY{p}{,} \PY{k}{lambda} \PY{n}{h}\PY{p}{:} \PY{n}{compute\PYZus{}E}\PY{p}{(}\PY{n}{h}\PY{p}{,} \PY{l+m+mi}{3}\PY{p}{)}\PY{p}{,} \PY{l+s+sa}{r}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{\PYZbs{}}\PY{l+s+s2}{frac}\PY{l+s+si}{\PYZob{}1\PYZcb{}}\PY{l+s+si}{\PYZob{}N\PYZcb{}}\PY{l+s+s2}{\PYZbs{}}\PY{l+s+s2}{mathbb}\PY{l+s+si}{\PYZob{}E\PYZcb{}}\PY{l+s+s2}{|}\PY{l+s+s2}{\PYZbs{}}\PY{l+s+s2}{mathbf}\PY{l+s+si}{\PYZob{}A\PYZcb{}}\PY{l+s+s2}{|}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
Taking t = 3 for the example
    ...
    $\displaystyle \frac{1}{N}\mathbb{E}|\mathbf{A}| = -\frac{2 \, {\left({\left(X - 1\right)} n + 2 \, X - 2\right)} β^{2} - 4 \, X^{2} - 2 \, {\left(X^{2} - X\right)} n + 2 \, {\left(2 \, X^{2} + {\left(X^{2} - 2 \, X + 1\right)} n - 4 \, X + 2\right)} β - {\left({\left(X^{4} - X^{3}\right)} n^{3} + 2 \, {\left(X^{4} - 3 \, X^{3} + 2 \, X^{2}\right)} n^{2} + {\left({\left(X^{2} - X\right)} n^{3} + 2 \, {\left(2 \, X^{2} - 3 \, X + 1\right)} n^{2} + 4 \, {\left(X^{2} - 2 \, X + 1\right)} n\right)} β^{2} - 4 \, {\left(X^{3} - 2 \, X^{2} + X\right)} n + 2 \, {\left({\left(X^{3} - X^{2}\right)} n^{3} + 3 \, {\left(X^{3} - 2 \, X^{2} + X\right)} n^{2} + 2 \, {\left(X^{3} - 3 \, X^{2} + 3 \, X - 1\right)} n\right)} β\right)} γ + 4 \, X}{2 \, {\left({\left(n + 2\right)} β - n - 2\right)}}$
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n+nd}{@memoized}
\PY{k}{def} \PY{n+nf}{compute\PYZus{}B}\PY{p}{(}\PY{n}{h}\PY{p}{,} \PY{n}{t}\PY{p}{)}\PY{p}{:}
    \PY{n}{E} \PY{o}{=} \PY{n}{compute\PYZus{}E}\PY{p}{(}\PY{n}{h}\PY{p}{,} \PY{n}{t}\PY{p}{)}
    \PY{n}{q} \PY{o}{=} \PY{n}{compute\PYZus{}q}\PY{p}{(}\PY{n}{t}\PY{p}{)}
    
    \PY{c+c1}{\PYZsh{} Now we expand X in terms of unknowns B\PYZus{}1, ..., B\PYZus{}q and replace it in E}
    \PY{n}{B} \PY{o}{=} \PY{n}{var}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{B}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{n}\PY{o}{=}\PY{n}{q}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{)}
    \PY{n}{E} \PY{o}{=} \PY{n}{E}\PY{o}{.}\PY{n}{subs}\PY{p}{(}\PY{n}{X} \PY{o}{==} \PY{n+nb}{sum}\PY{p}{(}\PY{p}{[}\PY{n}{B}\PY{p}{[}\PY{n}{j}\PY{p}{]} \PY{o}{*} \PY{n}{γ}\PY{o}{\PYZca{}}\PY{n}{j} \PY{o}{*} \PY{p}{(}\PY{l+m+mi}{1}\PY{o}{\PYZhy{}}\PY{n}{β}\PY{p}{)} \PY{k}{for} \PY{n}{j} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,} \PY{n}{q}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{]}\PY{p}{)}\PY{p}{)}\PY{o}{.}\PY{n}{simplify\PYZus{}rational}\PY{p}{(}\PY{p}{)}

    \PY{n}{substs} \PY{o}{=} \PY{p}{[}\PY{p}{]}
    \PY{n}{coeffs} \PY{o}{=} \PY{n}{E}\PY{o}{.}\PY{n}{polynomial}\PY{p}{(}\PY{n}{ring}\PY{o}{=}\PY{n}{SR}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{γ}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}\PY{o}{.}\PY{n}{coefficients}\PY{p}{(}\PY{n}{sparse}\PY{o}{=}\PY{k+kc}{False}\PY{p}{)}
    \PY{k}{assert} \PY{n+nb}{bool}\PY{p}{(}\PY{n}{coeffs}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]} \PY{o}{==} \PY{n}{β}\PY{p}{)}

    \PY{n}{B\PYZus{}ans} \PY{o}{=} \PY{p}{\PYZob{}}\PY{p}{\PYZcb{}}
    \PY{k}{for} \PY{n}{j} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,} \PY{n}{q}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{:}
        \PY{n}{ans} \PY{o}{=} \PY{n}{solve}\PY{p}{(}\PY{p}{[}\PY{n}{coeffs}\PY{p}{[}\PY{n}{j}\PY{p}{]}\PY{o}{.}\PY{n}{subs}\PY{p}{(}\PY{n}{substs}\PY{p}{)} \PY{o}{==} \PY{l+m+mi}{0}\PY{p}{]}\PY{p}{,} \PY{n}{B}\PY{p}{[}\PY{n}{j}\PY{p}{]}\PY{p}{)}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}
        \PY{n}{B\PYZus{}ans}\PY{p}{[}\PY{n}{j}\PY{p}{]} \PY{o}{=} \PY{n}{B}\PY{p}{[}\PY{n}{j}\PY{p}{]}\PY{o}{.}\PY{n}{subs}\PY{p}{(}\PY{n}{ans}\PY{p}{)}
        \PY{n}{substs}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{ans}\PY{p}{)}

    \PY{k}{return} \PY{n}{B\PYZus{}ans}

\PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Taking t = 8 for the example}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\PY{n}{display\PYZus{}table}\PY{p}{(}\PY{l+m+mi}{3}\PY{p}{,} \PY{k}{lambda} \PY{n}{h}\PY{p}{:} \PY{n}{compute\PYZus{}B}\PY{p}{(}\PY{n}{h}\PY{p}{,} \PY{l+m+mi}{8}\PY{p}{)}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{B}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{k}{def} \PY{n+nf}{compute\PYZus{}X}\PY{p}{(}\PY{n}{h}\PY{p}{,} \PY{n}{t}\PY{p}{)}\PY{p}{:}
    \PY{n}{B} \PY{o}{=} \PY{n}{compute\PYZus{}B}\PY{p}{(}\PY{n}{h}\PY{p}{,} \PY{n}{t}\PY{p}{)}
    \PY{n}{q} \PY{o}{=} \PY{n}{compute\PYZus{}q}\PY{p}{(}\PY{n}{t}\PY{p}{)}
    \PY{k}{return} \PY{n+nb}{sum}\PY{p}{(}\PY{p}{[}\PY{n}{B}\PY{p}{[}\PY{n}{j}\PY{p}{]} \PY{o}{*} \PY{n}{γ}\PY{o}{\PYZca{}}\PY{n}{j} \PY{o}{*} \PY{p}{(}\PY{l+m+mi}{1}\PY{o}{\PYZhy{}}\PY{n}{β}\PY{p}{)} \PY{k}{for} \PY{n}{j} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,} \PY{n}{q}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{]}\PY{p}{)}

\PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Taking t = 8 for the example}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\PY{n}{display\PYZus{}table}\PY{p}{(}\PY{l+m+mi}{3}\PY{p}{,} \PY{k}{lambda} \PY{n}{h}\PY{p}{:} \PY{n}{compute\PYZus{}X}\PY{p}{(}\PY{n}{h}\PY{p}{,} \PY{l+m+mi}{8}\PY{p}{)}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{X}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
Taking logs, dividing by \(N = \binom{n}{k}\) and Taylor expanding, we
may write
...
Recall that we already solved for \(X\) as a function of \(n\),
\(\beta\) and \(\gamma\). Substituting, it only remains to collect the
coefficients of \(\gamma\). Up to multiplying by \((1-\beta)^j\) (to
correct for the fact that \(\gamma = (1-\beta)^{k+1}\) while the \(R_j\)
are the coefficients of a power series in \((1-\beta)^{k}\)), these are
our \(R_j\)s.
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n+nd}{@memoized}
\PY{k}{def} \PY{n+nf}{compute\PYZus{}R}\PY{p}{(}\PY{n}{h}\PY{p}{)}\PY{p}{:}
    \PY{n}{S} \PY{o}{=} \PY{n}{compute\PYZus{}S}\PY{p}{(}\PY{n}{h}\PY{p}{)}
    \PY{n}{t} \PY{o}{=} \PY{l+m+mi}{1} \PY{o}{+} \PY{n+nb}{max}\PY{p}{(}\PY{n}{S}\PY{o}{.}\PY{n}{keys}\PY{p}{(}\PY{p}{)}\PY{p}{)}

    \PY{c+c1}{\PYZsh{} The first part of the above equation, as per 5.22}
    \PY{n}{taylr} \PY{o}{=} \PY{n+nb}{sum}\PY{p}{(}\PY{p}{[}\PY{p}{(}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{)}\PY{o}{\PYZca{}}\PY{p}{(}\PY{n}{i}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{)}\PY{o}{/}\PY{n}{i} \PY{o}{*} \PY{p}{(}\PY{l+m+mi}{1}\PY{o}{\PYZhy{}}\PY{n}{β}\PY{o}{\PYZca{}}\PY{p}{(}\PY{l+m+mi}{1}\PY{o}{\PYZhy{}}\PY{n}{i}\PY{p}{)}\PY{p}{)} \PY{o}{*} \PY{n}{X}\PY{o}{\PYZca{}}\PY{n}{i} \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,} \PY{n}{t}\PY{p}{)}\PY{p}{]}\PY{p}{)}
    
    \PY{c+c1}{\PYZsh{} To consider the remaining terms, we expand (1+λ)\PYZca{}\PYZob{}\PYZhy{}j(k+1)\PYZcb{} }
    \PY{c+c1}{\PYZsh{} by Newton\PYZsq{}s binomial theorem, as before}
    \PY{k}{for} \PY{n}{j} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,} \PY{n}{t}\PY{p}{)}\PY{p}{:}
        \PY{n}{pow\PYZus{}lambda} \PY{o}{=} \PY{n}{γ}\PY{o}{\PYZca{}}\PY{n}{j} \PY{o}{*} \PY{n+nb}{sum}\PY{p}{(}\PY{p}{[}\PY{n}{binomial}\PY{p}{(}\PY{o}{\PYZhy{}}\PY{n}{j}\PY{o}{*}\PY{p}{(}\PY{n}{k}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{,} \PY{n}{i}\PY{p}{)} \PY{o}{*} \PY{n}{X}\PY{o}{\PYZca{}}\PY{n}{i} \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{t}\PY{p}{)}\PY{p}{]}\PY{p}{)}
        \PY{n}{second\PYZus{}sum} \PY{o}{=} \PY{n}{k} \PY{o}{/} \PY{p}{(}\PY{n}{n} \PY{o}{\PYZhy{}} \PY{n}{k} \PY{o}{+} \PY{l+m+mi}{1}\PY{p}{)} \PY{o}{*} \PY{n}{S}\PY{p}{[}\PY{n}{j}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]} \PY{o}{+} \PY{p}{(}\PY{n}{n} \PY{o}{\PYZhy{}} \PY{n}{k}\PY{p}{)} \PY{o}{/} \PY{p}{(}\PY{n}{k} \PY{o}{+} \PY{l+m+mi}{1}\PY{p}{)} \PY{o}{*} \PY{n}{S}\PY{p}{[}\PY{n}{j}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}
        \PY{n}{taylr} \PY{o}{+}\PY{o}{=} \PY{n}{second\PYZus{}sum}\PY{o}{.}\PY{n}{subs}\PY{p}{(}\PY{n}{λ} \PY{o}{==} \PY{p}{(}\PY{n}{β}\PY{o}{+}\PY{n}{X}\PY{p}{)}\PY{o}{/}\PY{p}{(}\PY{l+m+mi}{1}\PY{o}{\PYZhy{}}\PY{n}{β}\PY{p}{)}\PY{p}{)} \PY{o}{*} \PY{n}{pow\PYZus{}lambda}
    \PY{n}{taylr} \PY{o}{=} \PY{n}{clean}\PY{p}{(}\PY{n}{h}\PY{p}{,} \PY{n}{taylr}\PY{p}{)}\PY{o}{.}\PY{n}{subs}\PY{p}{(}\PY{n}{X} \PY{o}{==} \PY{n}{compute\PYZus{}X}\PY{p}{(}\PY{n}{h}\PY{p}{,} \PY{n}{t}\PY{p}{)}\PY{p}{)}

    \PY{c+c1}{\PYZsh{} It remains to compare coefficients and multiply by (1\PYZhy{}β)\PYZca{}j}
    \PY{c+c1}{\PYZsh{} TODO: Why is computing coeffs so slow? Is expanding X\PYZca{}i the bottleneck?}
    \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Collecting coefficients}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
    \PY{n}{coeffs} \PY{o}{=} \PY{n}{taylr}\PY{o}{.}\PY{n}{polynomial}\PY{p}{(}\PY{n}{ring}\PY{o}{=}\PY{n}{SR}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{γ}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}\PY{o}{.}\PY{n}{list}\PY{p}{(}\PY{p}{)}
    \PY{k}{assert} \PY{n+nb}{bool}\PY{p}{(}\PY{n}{coeffs}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]} \PY{o}{==} \PY{l+m+mi}{0}\PY{p}{)}
    
    \PY{n}{R} \PY{o}{=} \PY{p}{\PYZob{}}\PY{p}{\PYZcb{}}
    \PY{k}{for} \PY{n}{j} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,} \PY{n}{t}\PY{p}{)}\PY{p}{:}
        \PY{n}{R}\PY{p}{[}\PY{n}{j}\PY{p}{]} \PY{o}{=} \PY{p}{(}\PY{n}{coeffs}\PY{p}{[}\PY{n}{j}\PY{p}{]} \PY{o}{*} \PY{p}{(}\PY{l+m+mi}{1}\PY{o}{\PYZhy{}}\PY{n}{β}\PY{p}{)}\PY{o}{\PYZca{}}\PY{n}{j}\PY{p}{)}\PY{o}{.}\PY{n}{simplify\PYZus{}rational}\PY{p}{(}\PY{p}{)}
    \PY{k}{return} \PY{n}{R}

\PY{n}{display\PYZus{}table}\PY{p}{(}\PY{l+m+mi}{6}\PY{p}{,} \PY{n}{compute\PYZus{}R}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{R}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
Collecting coefficients
    ...
    $\displaystyle R_1 = \frac{2 \, n β}{n + 2}$

    
    $\displaystyle $

    
    $\displaystyle R_2 = -\frac{{\left(n^{4} + 8 \, n^{3} + 12 \, n^{2}\right)} β^{3} + 16 \, n^{2} β + {\left(n^{4} - 12 \, n^{3} - 20 \, n^{2} + 16 \, n\right)} β^{2}}{8 \, {\left(n^{2} - {\left(n^{2} + 4 \, n + 4\right)} β + 4 \, n + 4\right)}}$

    
    $\displaystyle $

    
    $\displaystyle R_3 = \frac{{\left(3 \, n^{7} + 40 \, n^{6} + 256 \, n^{5} + 752 \, n^{4} + 976 \, n^{3} + 448 \, n^{2}\right)} β^{6} + 3 \, {\left(n^{7} - 24 \, n^{6} - 320 \, n^{5} - 944 \, n^{4} - 784 \, n^{3} + 64 \, n^{2}\right)} β^{5} - {\left(3 \, n^{7} + 48 \, n^{6} - 1152 \, n^{5} - 4432 \, n^{4} - 2736 \, n^{3} + 2112 \, n^{2} - 512 \, n\right)} β^{4} - 512 \, n^{3} β - {\left(3 \, n^{7} - 72 \, n^{6} + 384 \, n^{5} + 3504 \, n^{4} + 2640 \, n^{3} - 3136 \, n^{2} + 512 \, n\right)} β^{3} - 96 \, {\left(n^{5} - 12 \, n^{4} - 20 \, n^{3} + 16 \, n^{2}\right)} β^{2}}{192 \, {\left({\left(n^{3} + 6 \, n^{2} + 12 \, n + 8\right)} β^{3} - n^{3} - 3 \, {\left(n^{3} + 6 \, n^{2} + 12 \, n + 8\right)} β^{2} - 6 \, n^{2} + 3 \, {\left(n^{3} + 6 \, n^{2} + 12 \, n + 8\right)} β - 12 \, n - 8\right)}}$

    
    $\displaystyle $

    
    $\displaystyle R_4 = \frac{{\left(n^{10} + 18 \, n^{9} + 182 \, n^{8} + 1040 \, n^{7} + 3600 \, n^{6} + 8128 \, n^{5} + 12192 \, n^{4} + 11136 \, n^{3} + 4608 \, n^{2}\right)} β^{10} - 18 \, {\left(3 \, n^{9} + 54 \, n^{8} + 396 \, n^{7} + 1456 \, n^{6} + 2928 \, n^{5} + 3360 \, n^{4} + 2240 \, n^{3} + 768 \, n^{2}\right)} β^{9} - 3 \, {\left(n^{10} + 2 \, n^{9} - 550 \, n^{8} - 6584 \, n^{7} - 27232 \, n^{6} - 50304 \, n^{5} - 42656 \, n^{4} - 17152 \, n^{3} - 5888 \, n^{2}\right)} β^{8} + 2 \, {\left(57 \, n^{9} - 219 \, n^{8} - 14064 \, n^{7} - 72156 \, n^{6} - 128544 \, n^{5} - 73552 \, n^{4} - 1920 \, n^{3} - 11840 \, n^{2} + 768 \, n\right)} β^{7} + 3 \, {\left(n^{10} - 16 \, n^{9} - 522 \, n^{8} + 6804 \, n^{7} + 52456 \, n^{6} + 98528 \, n^{5} + 32864 \, n^{4} - 26432 \, n^{3} + 14720 \, n^{2} - 1536 \, n\right)} β^{6} - 6 \, {\left(10 \, n^{9} - 261 \, n^{8} + 816 \, n^{7} + 17564 \, n^{6} + 40144 \, n^{5} + 7888 \, n^{4} - 21504 \, n^{3} + 9280 \, n^{2} - 768 \, n\right)} β^{5} - 1536 \, n^{4} β - {\left(n^{10} - 36 \, n^{9} + 372 \, n^{8} + 2196 \, n^{7} - 38896 \, n^{6} - 134944 \, n^{5} - 33408 \, n^{4} + 107200 \, n^{3} - 36096 \, n^{2} + 1536 \, n\right)} β^{4} - 48 \, {\left(n^{8} - 24 \, n^{7} + 106 \, n^{6} + 956 \, n^{5} + 568 \, n^{4} - 1008 \, n^{3} + 192 \, n^{2}\right)} β^{3} - 576 \, {\left(n^{6} - 12 \, n^{5} - 20 \, n^{4} + 16 \, n^{3}\right)} β^{2}}{384 \, {\left({\left(n^{4} + 8 \, n^{3} + 24 \, n^{2} + 32 \, n + 16\right)} β^{6} - 6 \, {\left(n^{4} + 8 \, n^{3} + 24 \, n^{2} + 32 \, n + 16\right)} β^{5} + 15 \, {\left(n^{4} + 8 \, n^{3} + 24 \, n^{2} + 32 \, n + 16\right)} β^{4} + n^{4} - 20 \, {\left(n^{4} + 8 \, n^{3} + 24 \, n^{2} + 32 \, n + 16\right)} β^{3} + 8 \, n^{3} + 15 \, {\left(n^{4} + 8 \, n^{3} + 24 \, n^{2} + 32 \, n + 16\right)} β^{2} + 24 \, n^{2} - 6 \, {\left(n^{4} + 8 \, n^{3} + 24 \, n^{2} + 32 \, n + 16\right)} β + 32 \, n + 16\right)}}$

    
    $\displaystyle $

    
    $\displaystyle R_5 = \frac{{\left(125 \, n^{13} + 2800 \, n^{12} + 37120 \, n^{11} + 285600 \, n^{10} + 1670624 \, n^{9} + 6859136 \, n^{8} + 17773312 \, n^{7} + 31354368 \, n^{6} + 51780864 \, n^{5} + 87029760 \, n^{4} + 96595968 \, n^{3} + 44531712 \, n^{2}\right)} β^{15} - 10 \, {\left(25 \, n^{13} + 1440 \, n^{12} + 28608 \, n^{11} + 285216 \, n^{10} + 1871456 \, n^{9} + 7796096 \, n^{8} + 20023040 \, n^{7} + 33834496 \, n^{6} + 47487232 \, n^{5} + 66127872 \, n^{4} + 67203072 \, n^{3} + 29982720 \, n^{2}\right)} β^{14} - 5 \, {\left(75 \, n^{13} - 3360 \, n^{12} - 160768 \, n^{11} - 2341536 \, n^{10} - 18264032 \, n^{9} - 80038784 \, n^{8} - 204881664 \, n^{7} - 327990784 \, n^{6} - 394315008 \, n^{5} - 452732928 \, n^{4} - 414855168 \, n^{3} - 176259072 \, n^{2}\right)} β^{13} + 40 \, {\left(25 \, n^{13} + 650 \, n^{12} - 19984 \, n^{11} - 626400 \, n^{10} - 6422656 \, n^{9} - 30869696 \, n^{8} - 79586176 \, n^{7} - 119388672 \, n^{6} - 121497856 \, n^{5} - 114146816 \, n^{4} - 94132224 \, n^{3} - 37126144 \, n^{2}\right)} β^{12} + 2 \, {\left(125 \, n^{13} - 33000 \, n^{12} - 300480 \, n^{11} + 13559840 \, n^{10} + 229576800 \, n^{9} + 1277996160 \, n^{8} + 3377849600 \, n^{7} + 4709152256 \, n^{6} + 3908752640 \, n^{5} + 2947112960 \, n^{4} + 2276659200 \, n^{3} + 782991360 \, n^{2} + 786432 \, n\right)} β^{11} - 4 \, {\left(375 \, n^{13} - 3300 \, n^{12} - 521680 \, n^{11} + 1253088 \, n^{10} + 133303072 \, n^{9} + 932882944 \, n^{8} + 2600352000 \, n^{7} + 3365069312 \, n^{6} + 2100666112 \, n^{5} + 1193026560 \, n^{4} + 1033773056 \, n^{3} + 249790464 \, n^{2} + 2359296 \, n\right)} β^{10} + 10 \, {\left(25 \, n^{13} + 6440 \, n^{12} - 146592 \, n^{11} - 2460384 \, n^{10} + 38177248 \, n^{9} + 390940800 \, n^{8} + 1200015616 \, n^{7} + 1461399040 \, n^{6} + 573391104 \, n^{5} + 172298240 \, n^{4} + 343879680 \, n^{3} + 19726336 \, n^{2} + 2359296 \, n\right)} β^{9} + 40 \, {\left(25 \, n^{13} - 1170 \, n^{12} - 10904 \, n^{11} + 812448 \, n^{10} - 3133664 \, n^{9} - 72787136 \, n^{8} - 262529280 \, n^{7} - 313051648 \, n^{6} - 45544192 \, n^{5} + 32042496 \, n^{4} - 77772800 \, n^{3} + 9093120 \, n^{2} - 786432 \, n\right)} β^{8} - 5 \, {\left(75 \, n^{13} + 2400 \, n^{12} - 230144 \, n^{11} + 3613536 \, n^{10} + 7275552 \, n^{9} - 294892416 \, n^{8} - 1383759616 \, n^{7} - 1740717568 \, n^{6} + 124058368 \, n^{5} + 553179136 \, n^{4} - 549007360 \, n^{3} + 97812480 \, n^{2} - 4718592 \, n\right)} β^{7} - 2 \, {\left(125 \, n^{13} - 11000 \, n^{12} + 290400 \, n^{11} - 1828320 \, n^{10} - 27706400 \, n^{9} + 224830080 \, n^{8} + 1663512320 \, n^{7} + 2460141056 \, n^{6} - 463094528 \, n^{5} - 1304064000 \, n^{4} + 949800960 \, n^{3} - 155811840 \, n^{2} + 4718592 \, n\right)} β^{6} + 1572864 \, n^{5} β + {\left(125 \, n^{13} - 6000 \, n^{12} + 82880 \, n^{11} + 612640 \, n^{10} - 21678880 \, n^{9} + 49107840 \, n^{8} + 1092007680 \, n^{7} + 2176570880 \, n^{6} - 330535680 \, n^{5} - 1597687808 \, n^{4} + 894038016 \, n^{3} - 107118592 \, n^{2} + 1572864 \, n\right)} β^{5} + 320 \, {\left(25 \, n^{11} - 900 \, n^{10} + 8604 \, n^{9} + 40896 \, n^{8} - 661840 \, n^{7} - 2158144 \, n^{6} - 134592 \, n^{5} + 2002432 \, n^{4} - 783360 \, n^{3} + 49152 \, n^{2}\right)} β^{4} + 30720 \, {\left(5 \, n^{9} - 120 \, n^{8} + 496 \, n^{7} + 4400 \, n^{6} + 2288 \, n^{5} - 4928 \, n^{4} + 1024 \, n^{3}\right)} β^{3} + 983040 \, {\left(n^{7} - 12 \, n^{6} - 20 \, n^{5} + 16 \, n^{4}\right)} β^{2}}{245760 \, {\left({\left(n^{5} + 10 \, n^{4} + 40 \, n^{3} + 80 \, n^{2} + 80 \, n + 32\right)} β^{10} - 10 \, {\left(n^{5} + 10 \, n^{4} + 40 \, n^{3} + 80 \, n^{2} + 80 \, n + 32\right)} β^{9} + 45 \, {\left(n^{5} + 10 \, n^{4} + 40 \, n^{3} + 80 \, n^{2} + 80 \, n + 32\right)} β^{8} - 120 \, {\left(n^{5} + 10 \, n^{4} + 40 \, n^{3} + 80 \, n^{2} + 80 \, n + 32\right)} β^{7} + 210 \, {\left(n^{5} + 10 \, n^{4} + 40 \, n^{3} + 80 \, n^{2} + 80 \, n + 32\right)} β^{6} - 252 \, {\left(n^{5} + 10 \, n^{4} + 40 \, n^{3} + 80 \, n^{2} + 80 \, n + 32\right)} β^{5} + n^{5} + 210 \, {\left(n^{5} + 10 \, n^{4} + 40 \, n^{3} + 80 \, n^{2} + 80 \, n + 32\right)} β^{4} + 10 \, n^{4} - 120 \, {\left(n^{5} + 10 \, n^{4} + 40 \, n^{3} + 80 \, n^{2} + 80 \, n + 32\right)} β^{3} + 40 \, n^{3} + 45 \, {\left(n^{5} + 10 \, n^{4} + 40 \, n^{3} + 80 \, n^{2} + 80 \, n + 32\right)} β^{2} + 80 \, n^{2} - 10 \, {\left(n^{5} + 10 \, n^{4} + 40 \, n^{3} + 80 \, n^{2} + 80 \, n + 32\right)} β + 80 \, n + 32\right)}}$

    
    $\displaystyle $

    
    $\displaystyle R_6 = \frac{3 \, {\left(27 \, n^{16} + 720 \, n^{15} + 11580 \, n^{14} + 109360 \, n^{13} + 871264 \, n^{12} + 4422464 \, n^{11} + 18211200 \, n^{10} + 72760320 \, n^{9} + 193960704 \, n^{8} + 215339008 \, n^{7} + 1530880 \, n^{6} + 422809600 \, n^{5} + 2180792320 \, n^{4} + 3052453888 \, n^{3} + 1422458880 \, n^{2}\right)} β^{21} - 45 \, {\left(9 \, n^{16} + 396 \, n^{15} + 8468 \, n^{14} + 100160 \, n^{13} + 887520 \, n^{12} + 4988480 \, n^{11} + 21535360 \, n^{10} + 78964224 \, n^{9} + 195127552 \, n^{8} + 232442880 \, n^{7} + 85873664 \, n^{6} + 409133056 \, n^{5} + 1702035456 \, n^{4} + 2302296064 \, n^{3} + 1058734080 \, n^{2}\right)} β^{20} + 15 \, {\left(27 \, n^{16} + 3456 \, n^{15} + 113388 \, n^{14} + 1770624 \, n^{13} + 18183616 \, n^{12} + 114519488 \, n^{11} + 519663232 \, n^{10} + 1806197248 \, n^{9} + 4194460416 \, n^{8} + 5207277568 \, n^{7} + 3130989568 \, n^{6} + 8268963840 \, n^{5} + 27879890944 \, n^{4} + 36105240576 \, n^{3} + 16297295872 \, n^{2}\right)} β^{19} + 15 \, {\left(81 \, n^{16} - 2556 \, n^{15} - 247356 \, n^{14} - 5796976 \, n^{13} - 73275104 \, n^{12} - 529198464 \, n^{11} - 2549325440 \, n^{10} - 8605595648 \, n^{9} - 18997456640 \, n^{8} - 23989793792 \, n^{7} - 17776065536 \, n^{6} - 34193707008 \, n^{5} - 94281023488 \, n^{4} - 115696041984 \, n^{3} - 50922913792 \, n^{2}\right)} β^{18} - 15 \, {\left(189 \, n^{16} + 7776 \, n^{15} - 188364 \, n^{14} - 11061584 \, n^{13} - 192172288 \, n^{12} - 1654980928 \, n^{11} - 8604588928 \, n^{10} - 28799224320 \, n^{9} - 61038143232 \, n^{8} - 76753438720 \, n^{7} - 62297730048 \, n^{6} - 96928272384 \, n^{5} - 221119668224 \, n^{4} - 254231724032 \, n^{3} - 108229885952 \, n^{2}\right)} β^{17} - {\left(81 \, n^{16} - 273780 \, n^{15} - 4734540 \, n^{14} + 155914560 \, n^{13} + 5047692064 \, n^{12} + 55544578176 \, n^{11} + 319339999360 \, n^{10} + 1080838251520 \, n^{9} + 2219287655680 \, n^{8} + 2725433396224 \, n^{7} + 2256904102912 \, n^{6} + 2991881420800 \, n^{5} + 5725616373760 \, n^{4} + 6089370501120 \, n^{3} + 2483021283328 \, n^{2} - 7864320 \, n\right)} β^{16} + 5 \, {\left(1053 \, n^{16} - 19440 \, n^{15} - 2697516 \, n^{14} - 9072864 \, n^{13} + 1120867168 \, n^{12} + 18236402240 \, n^{11} + 120125914752 \, n^{10} + 419774910464 \, n^{9} + 842682510592 \, n^{8} + 992195094528 \, n^{7} + 793247667200 \, n^{6} + 923757469696 \, n^{5} + 1508339810304 \, n^{4} + 1460139212800 \, n^{3} + 564111540224 \, n^{2} - 15728640 \, n\right)} β^{15} - 15 \, {\left(243 \, n^{16} + 21708 \, n^{15} - 704532 \, n^{14} - 22131824 \, n^{13} + 185134400 \, n^{12} + 7328492672 \, n^{11} + 58423281536 \, n^{10} + 215855523328 \, n^{9} + 428138472192 \, n^{8} + 474752633856 \, n^{7} + 346649713664 \, n^{6} + 363261890560 \, n^{5} + 518470262784 \, n^{4} + 445522247680 \, n^{3} + 161564590080 \, n^{2} - 23592960 \, n\right)} β^{14} - 15 \, {\left(243 \, n^{16} - 27216 \, n^{15} - 313332 \, n^{14} + 27892464 \, n^{13} + 156883744 \, n^{12} - 6281173056 \, n^{11} - 66682041472 \, n^{10} - 268200886784 \, n^{9} - 532861781248 \, n^{8} - 547238606848 \, n^{7} - 338874864640 \, n^{6} - 329735196672 \, n^{5} - 429572161536 \, n^{4} - 311505141760 \, n^{3} - 106301947904 \, n^{2} + 62914560 \, n\right)} β^{13} + 15 \, {\left(351 \, n^{16} - 684 \, n^{15} - 1018164 \, n^{14} + 12856192 \, n^{13} + 408033440 \, n^{12} - 3386628672 \, n^{11} - 59373196160 \, n^{10} - 270093982720 \, n^{9} - 547832925440 \, n^{8} - 514272969728 \, n^{7} - 236822774784 \, n^{6} - 228175691776 \, n^{5} - 298000039936 \, n^{4} - 161128824832 \, n^{3} - 54480142336 \, n^{2} + 110100480 \, n\right)} β^{12} - 3 \, {\left(27 \, n^{16} + 99360 \, n^{15} - 3431700 \, n^{14} - 37330320 \, n^{13} + 2029080160 \, n^{12} - 2356892480 \, n^{11} - 202820316800 \, n^{10} - 1101495073280 \, n^{9} - 2341979831552 \, n^{8} - 2002426669056 \, n^{7} - 491001959424 \, n^{6} - 571608453120 \, n^{5} - 932483645440 \, n^{4} - 264444329984 \, n^{3} - 113935056896 \, n^{2} + 660602880 \, n\right)} β^{11} - 15 \, {\left(189 \, n^{16} - 13068 \, n^{15} - 45324 \, n^{14} + 15170304 \, n^{13} - 230242112 \, n^{12} - 993385344 \, n^{11} + 20423992960 \, n^{10} + 144315370496 \, n^{9} + 333475704064 \, n^{8} + 263927174144 \, n^{7} - 6999899136 \, n^{6} + 31685459968 \, n^{5} + 115658956800 \, n^{4} - 182910976 \, n^{3} + 8713535488 \, n^{2} - 110100480 \, n\right)} β^{10} + 15 \, {\left(81 \, n^{16} + 1152 \, n^{15} - 344700 \, n^{14} + 10284624 \, n^{13} - 65960448 \, n^{12} - 1019277248 \, n^{11} + 6844616576 \, n^{10} + 74566093824 \, n^{9} + 196548624640 \, n^{8} + 151028224000 \, n^{7} - 48703761408 \, n^{6} - 9399668736 \, n^{5} + 72986124288 \, n^{4} - 14485241856 \, n^{3} + 3467837440 \, n^{2} - 62914560 \, n\right)} β^{9} + 15 \, {\left(27 \, n^{16} - 4860 \, n^{15} + 220284 \, n^{14} - 3494368 \, n^{13} - 2888928 \, n^{12} + 513060224 \, n^{11} - 992639360 \, n^{10} - 29406003712 \, n^{9} - 94450300160 \, n^{8} - 76577940480 \, n^{7} + 43197242368 \, n^{6} + 20186234880 \, n^{5} - 43084185600 \, n^{4} + 11497930752 \, n^{3} - 1362886656 \, n^{2} + 23592960 \, n\right)} β^{8} - 5 \, {\left(81 \, n^{16} - 6480 \, n^{15} + 180900 \, n^{14} - 1286928 \, n^{13} - 28054592 \, n^{12} + 436269888 \, n^{11} + 931823488 \, n^{10} - 24993155072 \, n^{9} - 107971307264 \, n^{8} - 102679175168 \, n^{7} + 68282217472 \, n^{6} + 48371863552 \, n^{5} - 63700951040 \, n^{4} + 16259334144 \, n^{3} - 1280638976 \, n^{2} + 15728640 \, n\right)} β^{7} + 7864320 \, n^{6} β + {\left(81 \, n^{16} - 4860 \, n^{15} + 77220 \, n^{14} + 1082400 \, n^{13} - 44194240 \, n^{12} + 272426688 \, n^{11} + 3158817920 \, n^{10} - 22256197120 \, n^{9} - 155822553856 \, n^{8} - 193758555136 \, n^{7} + 115630343168 \, n^{6} + 129054064640 \, n^{5} - 119758888960 \, n^{4} + 24954912768 \, n^{3} - 1280770048 \, n^{2} + 7864320 \, n\right)} β^{6} + 240 \, {\left(27 \, n^{14} - 1296 \, n^{13} + 18072 \, n^{12} + 64240 \, n^{11} - 3011632 \, n^{10} + 6091264 \, n^{9} + 131435968 \, n^{8} + 238880768 \, n^{7} - 92251136 \, n^{6} - 200732672 \, n^{5} + 131652608 \, n^{4} - 19263488 \, n^{3} + 491520 \, n^{2}\right)} β^{5} + 19200 \, {\left(9 \, n^{12} - 324 \, n^{11} + 3024 \, n^{10} + 12888 \, n^{9} - 200560 \, n^{8} - 627200 \, n^{7} + 32128 \, n^{6} + 626560 \, n^{5} - 269312 \, n^{4} + 20480 \, n^{3}\right)} β^{4} + 614400 \, {\left(3 \, n^{10} - 72 \, n^{9} + 288 \, n^{8} + 2520 \, n^{7} + 1200 \, n^{6} - 2912 \, n^{5} + 640 \, n^{4}\right)} β^{3} + 7372800 \, {\left(n^{8} - 12 \, n^{7} - 20 \, n^{6} + 16 \, n^{5}\right)} β^{2}}{737280 \, {\left({\left(n^{6} + 12 \, n^{5} + 60 \, n^{4} + 160 \, n^{3} + 240 \, n^{2} + 192 \, n + 64\right)} β^{15} - 15 \, {\left(n^{6} + 12 \, n^{5} + 60 \, n^{4} + 160 \, n^{3} + 240 \, n^{2} + 192 \, n + 64\right)} β^{14} + 105 \, {\left(n^{6} + 12 \, n^{5} + 60 \, n^{4} + 160 \, n^{3} + 240 \, n^{2} + 192 \, n + 64\right)} β^{13} - 455 \, {\left(n^{6} + 12 \, n^{5} + 60 \, n^{4} + 160 \, n^{3} + 240 \, n^{2} + 192 \, n + 64\right)} β^{12} + 1365 \, {\left(n^{6} + 12 \, n^{5} + 60 \, n^{4} + 160 \, n^{3} + 240 \, n^{2} + 192 \, n + 64\right)} β^{11} - 3003 \, {\left(n^{6} + 12 \, n^{5} + 60 \, n^{4} + 160 \, n^{3} + 240 \, n^{2} + 192 \, n + 64\right)} β^{10} + 5005 \, {\left(n^{6} + 12 \, n^{5} + 60 \, n^{4} + 160 \, n^{3} + 240 \, n^{2} + 192 \, n + 64\right)} β^{9} - 6435 \, {\left(n^{6} + 12 \, n^{5} + 60 \, n^{4} + 160 \, n^{3} + 240 \, n^{2} + 192 \, n + 64\right)} β^{8} + 6435 \, {\left(n^{6} + 12 \, n^{5} + 60 \, n^{4} + 160 \, n^{3} + 240 \, n^{2} + 192 \, n + 64\right)} β^{7} - 5005 \, {\left(n^{6} + 12 \, n^{5} + 60 \, n^{4} + 160 \, n^{3} + 240 \, n^{2} + 192 \, n + 64\right)} β^{6} - n^{6} + 3003 \, {\left(n^{6} + 12 \, n^{5} + 60 \, n^{4} + 160 \, n^{3} + 240 \, n^{2} + 192 \, n + 64\right)} β^{5} - 12 \, n^{5} - 1365 \, {\left(n^{6} + 12 \, n^{5} + 60 \, n^{4} + 160 \, n^{3} + 240 \, n^{2} + 192 \, n + 64\right)} β^{4} - 60 \, n^{4} + 455 \, {\left(n^{6} + 12 \, n^{5} + 60 \, n^{4} + 160 \, n^{3} + 240 \, n^{2} + 192 \, n + 64\right)} β^{3} - 160 \, n^{3} - 105 \, {\left(n^{6} + 12 \, n^{5} + 60 \, n^{4} + 160 \, n^{3} + 240 \, n^{2} + 192 \, n + 64\right)} β^{2} - 240 \, n^{2} + 15 \, {\left(n^{6} + 12 \, n^{5} + 60 \, n^{4} + 160 \, n^{3} + 240 \, n^{2} + 192 \, n + 64\right)} β - 192 \, n - 64\right)}}$
...
Collecting coefficients
    ...
    $\displaystyle R_1 = \frac{{\left(n - 1\right)} β^{2} - 2 \, {\left(n + 1\right)} β}{{\left(n + 3\right)} β - n - 3}$

    
    $\displaystyle $

    
    $\displaystyle R_2 = \frac{2 \, {\left(n^{3} + 3 \, n^{2} - n - 3\right)} β^{5} - {\left(n^{4} + 14 \, n^{3} + 20 \, n^{2} - 38 \, n + 3\right)} β^{4} + 4 \, {\left(5 \, n^{3} + 13 \, n^{2} - 13 \, n - 5\right)} β^{3} + {\left(n^{4} - 10 \, n^{3} - 64 \, n^{2} - 22 \, n + 31\right)} β^{2} + 16 \, {\left(n^{2} + 2 \, n + 1\right)} β}{8 \, {\left({\left(n^{2} + 6 \, n + 9\right)} β^{3} - 3 \, {\left(n^{2} + 6 \, n + 9\right)} β^{2} - n^{2} + 3 \, {\left(n^{2} + 6 \, n + 9\right)} β - 6 \, n - 9\right)}}$
    ...
    $\displaystyle R_4 = -\frac{8 \, {\left(11 \, n^{8} + 116 \, n^{7} + 228 \, n^{6} - 1796 \, n^{5} - 10310 \, n^{4} - 18516 \, n^{3} - 4428 \, n^{2} + 20196 \, n + 14499\right)} β^{14} + {\left(n^{10} + 12 \, n^{9} - 469 \, n^{8} - 2328 \, n^{7} + 22418 \, n^{6} + 214080 \, n^{5} + 682750 \, n^{4} + 881304 \, n^{3} - 30051 \, n^{2} - 1093068 \, n - 674649\right)} β^{13} - 3 \, {\left(3 \, n^{10} + 84 \, n^{9} + 585 \, n^{8} + 9560 \, n^{7} + 91606 \, n^{6} + 394368 \, n^{5} + 819242 \, n^{4} + 688552 \, n^{3} - 317193 \, n^{2} - 1092564 \, n - 594243\right)} β^{12} + {\left(13 \, n^{10} + 860 \, n^{9} + 14999 \, n^{8} + 197128 \, n^{7} + 1252842 \, n^{6} + 3744192 \, n^{5} + 5029430 \, n^{4} + 1810168 \, n^{3} - 3117767 \, n^{2} - 5967388 \, n - 2964477\right)} β^{11} + {\left(19 \, n^{10} - 764 \, n^{9} - 35911 \, n^{8} - 573928 \, n^{7} - 3398154 \, n^{6} - 8254176 \, n^{5} - 6412150 \, n^{4} + 2498408 \, n^{3} + 4733383 \, n^{2} + 7909468 \, n + 3533805\right)} β^{10} - 3 \, {\left(15 \, n^{10} + 332 \, n^{9} - 11291 \, n^{8} - 318504 \, n^{7} - 2079666 \, n^{6} - 4750288 \, n^{5} - 1892958 \, n^{4} + 3957992 \, n^{3} + 1328627 \, n^{2} + 2718148 \, n + 1047593\right)} β^{9} - {\left(3 \, n^{10} - 2268 \, n^{9} - 6231 \, n^{8} + 953624 \, n^{7} + 8050390 \, n^{6} + 20040544 \, n^{5} + 5772522 \, n^{4} - 23541400 \, n^{3} - 3763465 \, n^{2} - 5284100 \, n - 2219619\right)} β^{8} + {\left(47 \, n^{10} - 876 \, n^{9} - 43203 \, n^{8} + 521176 \, n^{7} + 7230158 \, n^{6} + 22156160 \, n^{5} + 9872338 \, n^{4} - 29252824 \, n^{3} - 8590829 \, n^{2} - 452372 \, n - 1243167\right)} β^{7} - 3 \, {\left(5 \, n^{10} + 332 \, n^{9} - 12945 \, n^{8} + 25032 \, n^{7} + 1439322 \, n^{6} + 5993568 \, n^{5} + 4909222 \, n^{4} - 7329608 \, n^{3} - 4949551 \, n^{2} + 360404 \, n - 42565\right)} β^{6} - 8 \, {\left(2 \, n^{10} - 125 \, n^{9} + 1764 \, n^{8} + 9912 \, n^{7} - 194132 \, n^{6} - 1241890 \, n^{5} - 1739272 \, n^{4} + 945424 \, n^{3} + 1722994 \, n^{2} + 188375 \, n - 61692\right)} β^{5} + 8 \, {\left(n^{10} - 32 \, n^{9} + 129 \, n^{8} + 5728 \, n^{7} - 32110 \, n^{6} - 425072 \, n^{5} - 975446 \, n^{4} - 174464 \, n^{3} + 775853 \, n^{2} + 348080 \, n - 14187\right)} β^{4} + 384 \, {\left(n^{8} - 20 \, n^{7} - 15 \, n^{6} + 1590 \, n^{5} + 6253 \, n^{4} + 5648 \, n^{3} - 1777 \, n^{2} - 3378 \, n - 622\right)} β^{3} + 1536 \, {\left(3 \, n^{6} - 24 \, n^{5} - 217 \, n^{4} - 416 \, n^{3} - 231 \, n^{2} + 56 \, n + 61\right)} β^{2} + 12288 \, {\left(n^{4} + 4 \, n^{3} + 6 \, n^{2} + 4 \, n + 1\right)} β}{3072 \, {\left({\left(n^{4} + 12 \, n^{3} + 54 \, n^{2} + 108 \, n + 81\right)} β^{10} - 10 \, {\left(n^{4} + 12 \, n^{3} + 54 \, n^{2} + 108 \, n + 81\right)} β^{9} + 45 \, {\left(n^{4} + 12 \, n^{3} + 54 \, n^{2} + 108 \, n + 81\right)} β^{8} - 120 \, {\left(n^{4} + 12 \, n^{3} + 54 \, n^{2} + 108 \, n + 81\right)} β^{7} + 210 \, {\left(n^{4} + 12 \, n^{3} + 54 \, n^{2} + 108 \, n + 81\right)} β^{6} - 252 \, {\left(n^{4} + 12 \, n^{3} + 54 \, n^{2} + 108 \, n + 81\right)} β^{5} + 210 \, {\left(n^{4} + 12 \, n^{3} + 54 \, n^{2} + 108 \, n + 81\right)} β^{4} + n^{4} - 120 \, {\left(n^{4} + 12 \, n^{3} + 54 \, n^{2} + 108 \, n + 81\right)} β^{3} + 12 \, n^{3} + 45 \, {\left(n^{4} + 12 \, n^{3} + 54 \, n^{2} + 108 \, n + 81\right)} β^{2} + 54 \, n^{2} - 10 \, {\left(n^{4} + 12 \, n^{3} + 54 \, n^{2} + 108 \, n + 81\right)} β + 108 \, n + 81\right)}}$

    
    $\displaystyle $

    
    $\displaystyle R_5 = \frac{64 \, {\left(15 \, n^{11} - 125 \, n^{10} - 3955 \, n^{9} - 29351 \, n^{8} - 87322 \, n^{7} + 83758 \, n^{6} + 1589546 \, n^{5} + 5298306 \, n^{4} + 7044219 \, n^{3} - 31617 \, n^{2} - 8542503 \, n - 5320971\right)} β^{20} - 5 \, {\left(n^{13} - 33 \, n^{12} + 454 \, n^{11} - 47678 \, n^{10} - 698749 \, n^{9} - 3407051 \, n^{8} - 2633180 \, n^{7} + 49673260 \, n^{6} + 285021367 \, n^{5} + 748360857 \, n^{4} + 878591286 \, n^{3} - 97103502 \, n^{2} - 1160281179 \, n - 697475853\right)} β^{19} + 10 \, {\left(15 \, n^{13} + 273 \, n^{12} + 4442 \, n^{11} - 117538 \, n^{10} - 1423635 \, n^{9} - 2420581 \, n^{8} + 33627548 \, n^{7} + 251754900 \, n^{6} + 899705657 \, n^{5} + 1898124023 \, n^{4} + 1932533226 \, n^{3} - 488350674 \, n^{2} - 2864447253 \, n - 1658990403\right)} β^{18} - 5 \, {\left(155 \, n^{13} + 5861 \, n^{12} + 112482 \, n^{11} + 205110 \, n^{10} + 1995729 \, n^{9} + 74874167 \, n^{8} + 630873292 \, n^{7} + 2635298084 \, n^{6} + 6847638477 \, n^{5} + 11688739267 \, n^{4} + 10109315634 \, n^{3} - 4583016250 \, n^{2} - 17589935769 \, n - 9816106239\right)} β^{17} + {\left(1185 \, n^{13} + 97595 \, n^{12} + 2709590 \, n^{11} + 27145850 \, n^{10} + 309651315 \, n^{9} + 2807185945 \, n^{8} + 14579139140 \, n^{7} + 44573263932 \, n^{6} + 88184221623 \, n^{5} + 120983054205 \, n^{4} + 86875793030 \, n^{3} - 66401841110 \, n^{2} - 189753335019 \, n - 102187087281\right)} β^{16} + 4 \, {\left(285 \, n^{13} - 28790 \, n^{12} - 1611030 \, n^{11} - 27371808 \, n^{10} - 350717421 \, n^{9} - 2665561102 \, n^{8} - 11245882804 \, n^{7} - 27180189776 \, n^{6} - 40622099245 \, n^{5} - 43456381586 \, n^{4} - 25483159062 \, n^{3} + 33746624176 \, n^{2} + 77112072413 \, n + 40174305750\right)} β^{15} - 5 \, {\left(1023 \, n^{13} + 18365 \, n^{12} - 1406326 \, n^{11} - 46027914 \, n^{10} - 727046643 \, n^{9} - 5439877521 \, n^{8} - 20683993476 \, n^{7} - 41121782044 \, n^{6} - 43624857879 \, n^{5} - 32616941045 \, n^{4} - 16461794854 \, n^{3} + 41848821190 \, n^{2} + 78960495659 \, n + 39914391465\right)} β^{14} + 20 \, {\left(152 \, n^{13} + 20057 \, n^{12} + 67332 \, n^{11} - 13449846 \, n^{10} - 313884260 \, n^{9} - 2538210241 \, n^{8} - 9365403000 \, n^{7} - 16008970068 \, n^{6} - 10423950928 \, n^{5} - 2522706969 \, n^{4} - 2384793612 \, n^{3} + 13050413930 \, n^{2} + 20473125532 \, n + 10047741921\right)} β^{13} + 10 \, {\left(561 \, n^{13} - 33781 \, n^{12} - 1406122 \, n^{11} + 10989946 \, n^{10} + 747822851 \, n^{9} + 7167408361 \, n^{8} + 27452739780 \, n^{7} + 43194534076 \, n^{6} + 12888364391 \, n^{5} - 15920740115 \, n^{4} + 2488230150 \, n^{3} - 26245443414 \, n^{2} - 35197105083 \, n - 16585361601\right)} β^{12} - {\left(7885 \, n^{13} + 163515 \, n^{12} - 16944530 \, n^{11} - 169861590 \, n^{10} + 5960025415 \, n^{9} + 77190794825 \, n^{8} + 327622643860 \, n^{7} + 519080338076 \, n^{6} + 40790346827 \, n^{5} - 408298019875 \, n^{4} + 1345399710 \, n^{3} - 194828466150 \, n^{2} - 256478387967 \, n - 112097376705\right)} β^{11} - 8 \, {\left(30 \, n^{13} - 59795 \, n^{12} + 723800 \, n^{11} + 42410962 \, n^{10} - 334923122 \, n^{9} - 7848195077 \, n^{8} - 39434388864 \, n^{7} - 68845436452 \, n^{6} - 3003491334 \, n^{5} + 73649888755 \, n^{4} + 8325346536 \, n^{3} + 9862436082 \, n^{2} + 19710176922 \, n + 7749682437\right)} β^{10} + 5 \, {\left(1149 \, n^{13} - 51893 \, n^{12} - 1322418 \, n^{11} + 57648458 \, n^{10} + 10334103 \, n^{9} - 7483238599 \, n^{8} - 48057080108 \, n^{7} - 99320062884 \, n^{6} - 17974458469 \, n^{5} + 119228897101 \, n^{4} + 35444180862 \, n^{3} - 2851871430 \, n^{2} + 14314931121 \, n + 5726123343\right)} β^{9} - 5 \, {\left(543 \, n^{13} + 16069 \, n^{12} - 1829462 \, n^{11} + 26631430 \, n^{10} + 197617997 \, n^{9} - 3051309977 \, n^{8} - 28130179140 \, n^{7} - 72552011068 \, n^{6} - 32545596279 \, n^{5} + 84920414595 \, n^{4} + 50229891450 \, n^{3} - 5793726122 \, n^{2} + 2077493547 \, n + 2206667313\right)} β^{8} - 10 \, {\left(101 \, n^{13} - 15539 \, n^{12} + 485830 \, n^{11} - 2589154 \, n^{10} - 70354025 \, n^{9} + 350249607 \, n^{8} + 6075408900 \, n^{7} + 20490919092 \, n^{6} + 16806251715 \, n^{5} - 19567936501 \, n^{4} - 22217736490 \, n^{3} - 888136370 \, n^{2} + 1368878241 \, n - 231496191\right)} β^{7} + {\left(1125 \, n^{13} - 68705 \, n^{12} + 1187150 \, n^{11} + 4544210 \, n^{10} - 249726305 \, n^{9} + 1692165 \, n^{8} + 18178337940 \, n^{7} + 85293412684 \, n^{6} + 111271980947 \, n^{5} - 40690337415 \, n^{4} - 124365732930 \, n^{3} - 34193241790 \, n^{2} + 8904491977 \, n + 1210609539\right)} β^{6} - 2 \, {\left(125 \, n^{13} - 5375 \, n^{12} + 32710 \, n^{11} + 1660550 \, n^{10} - 21915825 \, n^{9} - 128446765 \, n^{8} + 1671395140 \, n^{7} + 12309687140 \, n^{6} + 24151783755 \, n^{5} + 5689274007 \, n^{4} - 20219918186 \, n^{3} - 13159877962 \, n^{2} - 296554679 \, n + 572531445\right)} β^{5} - 640 \, {\left(25 \, n^{11} - 775 \, n^{10} + 2911 \, n^{9} + 105991 \, n^{8} - 418134 \, n^{7} - 7006134 \, n^{6} - 20778418 \, n^{5} - 16935490 \, n^{4} + 7672173 \, n^{3} + 14623405 \, n^{2} + 4084259 \, n - 224181\right)} β^{4} - 61440 \, {\left(5 \, n^{9} - 95 \, n^{8} - 172 \, n^{7} + 7012 \, n^{6} + 34342 \, n^{5} + 52046 \, n^{4} + 18340 \, n^{3} - 19788 \, n^{2} - 15651 \, n - 2311\right)} β^{3} - 1966080 \, {\left(n^{7} - 7 \, n^{6} - 79 \, n^{5} - 207 \, n^{4} - 213 \, n^{3} - 61 \, n^{2} + 35 \, n + 19\right)} β^{2} - 3145728 \, {\left(n^{5} + 5 \, n^{4} + 10 \, n^{3} + 10 \, n^{2} + 5 \, n + 1\right)} β}{491520 \, {\left({\left(n^{5} + 15 \, n^{4} + 90 \, n^{3} + 270 \, n^{2} + 405 \, n + 243\right)} β^{15} - 15 \, {\left(n^{5} + 15 \, n^{4} + 90 \, n^{3} + 270 \, n^{2} + 405 \, n + 243\right)} β^{14} + 105 \, {\left(n^{5} + 15 \, n^{4} + 90 \, n^{3} + 270 \, n^{2} + 405 \, n + 243\right)} β^{13} - 455 \, {\left(n^{5} + 15 \, n^{4} + 90 \, n^{3} + 270 \, n^{2} + 405 \, n + 243\right)} β^{12} + 1365 \, {\left(n^{5} + 15 \, n^{4} + 90 \, n^{3} + 270 \, n^{2} + 405 \, n + 243\right)} β^{11} - 3003 \, {\left(n^{5} + 15 \, n^{4} + 90 \, n^{3} + 270 \, n^{2} + 405 \, n + 243\right)} β^{10} + 5005 \, {\left(n^{5} + 15 \, n^{4} + 90 \, n^{3} + 270 \, n^{2} + 405 \, n + 243\right)} β^{9} - 6435 \, {\left(n^{5} + 15 \, n^{4} + 90 \, n^{3} + 270 \, n^{2} + 405 \, n + 243\right)} β^{8} + 6435 \, {\left(n^{5} + 15 \, n^{4} + 90 \, n^{3} + 270 \, n^{2} + 405 \, n + 243\right)} β^{7} - 5005 \, {\left(n^{5} + 15 \, n^{4} + 90 \, n^{3} + 270 \, n^{2} + 405 \, n + 243\right)} β^{6} + 3003 \, {\left(n^{5} + 15 \, n^{4} + 90 \, n^{3} + 270 \, n^{2} + 405 \, n + 243\right)} β^{5} - n^{5} - 1365 \, {\left(n^{5} + 15 \, n^{4} + 90 \, n^{3} + 270 \, n^{2} + 405 \, n + 243\right)} β^{4} - 15 \, n^{4} + 455 \, {\left(n^{5} + 15 \, n^{4} + 90 \, n^{3} + 270 \, n^{2} + 405 \, n + 243\right)} β^{3} - 90 \, n^{3} - 105 \, {\left(n^{5} + 15 \, n^{4} + 90 \, n^{3} + 270 \, n^{2} + 405 \, n + 243\right)} β^{2} - 270 \, n^{2} + 15 \, {\left(n^{5} + 15 \, n^{4} + 90 \, n^{3} + 270 \, n^{2} + 405 \, n + 243\right)} β - 405 \, n - 243\right)}}$

    
    $\displaystyle $

    
    $\displaystyle R_6 = \frac{3072 \, {\left(20 \, n^{13} + 293 \, n^{12} - 866 \, n^{11} - 30992 \, n^{10} - 189010 \, n^{9} - 525083 \, n^{8} - 507540 \, n^{7} + 3450824 \, n^{6} + 25620304 \, n^{5} + 78387135 \, n^{4} + 100992726 \, n^{3} - 5166072 \, n^{2} - 125915634 \, n - 76116105\right)} β^{27} - 3 \, {\left(n^{16} - 142 \, n^{15} - 4590 \, n^{14} + 162690 \, n^{13} + 1154262 \, n^{12} - 51981318 \, n^{11} - 684707350 \, n^{10} - 3166843670 \, n^{9} - 5239145688 \, n^{8} + 9232267734 \, n^{7} + 97395886806 \, n^{6} + 456752073798 \, n^{5} + 1254181048650 \, n^{4} + 1561891504446 \, n^{3} - 129494685906 \, n^{2} - 2024657183538 \, n - 1216159546185\right)} β^{26} + 30 \, {\left(9 \, n^{16} + 54 \, n^{15} - 3326 \, n^{14} + 27246 \, n^{13} - 1679954 \, n^{12} - 63933986 \, n^{11} - 596492630 \, n^{10} - 2051694250 \, n^{9} + 158643008 \, n^{8} + 23751208962 \, n^{7} + 108419490694 \, n^{6} + 374705460330 \, n^{5} + 926141669874 \, n^{4} + 1113333008490 \, n^{3} - 133514595378 \, n^{2} - 1509674076846 \, n - 900607032297\right)} β^{25} - 30 \, {\left(103 \, n^{16} + 2922 \, n^{15} + 32690 \, n^{14} + 348234 \, n^{13} - 13522562 \, n^{12} - 357283214 \, n^{11} - 2665819894 \, n^{10} - 4962204174 \, n^{9} + 31636443372 \, n^{8} + 215894626942 \, n^{7} + 703935660086 \, n^{6} + 1924896249950 \, n^{5} + 4297676389426 \, n^{4} + 4990427847206 \, n^{3} - 808470514674 \, n^{2} - 7125899587866 \, n - 4222098668547\right)} β^{24} + 30 \, {\left(479 \, n^{16} + 22634 \, n^{15} + 482818 \, n^{14} + 6152490 \, n^{13} - 12943474 \, n^{12} - 894212302 \, n^{11} - 4807971366 \, n^{10} + 17531010066 \, n^{9} + 268121544748 \, n^{8} + 1179912618494 \, n^{7} + 3091483423398 \, n^{6} + 6940588103550 \, n^{5} + 14056933189794 \, n^{4} + 15823541920998 \, n^{3} - 3300876946818 \, n^{2} - 23960685615930 \, n - 14110840779579\right)} β^{23} - 6 \, {\left(4943 \, n^{16} + 404762 \, n^{15} + 12735250 \, n^{14} + 213638490 \, n^{13} + 1390001118 \, n^{12} + 4449325218 \, n^{11} + 76192714794 \, n^{10} + 1047372297730 \, n^{9} + 6581592572444 \, n^{8} + 22589459866638 \, n^{7} + 49657535904726 \, n^{6} + 93285695979022 \, n^{5} + 172298057166610 \, n^{4} + 189396166164662 \, n^{3} - 49040323686930 \, n^{2} - 306328202097642 \, n - 179569612991835\right)} β^{22} + 2 \, {\left(2757 \, n^{16} + 2104230 \, n^{15} + 109745070 \, n^{14} + 2487285990 \, n^{13} + 27592214002 \, n^{12} + 244381502238 \, n^{11} + 2176651842262 \, n^{10} + 15184182300990 \, n^{9} + 68926873932796 \, n^{8} + 195917146130994 \, n^{7} + 366848495204586 \, n^{6} + 581097224745138 \, n^{5} + 986091114413310 \, n^{4} + 1070671014866058 \, n^{3} - 334530092144238 \, n^{2} - 1863371746220118 \, n - 1089285437926065\right)} β^{21} + 30 \, {\left(3291 \, n^{16} - 31118 \, n^{15} - 11553030 \, n^{14} - 403699886 \, n^{13} - 6297407146 \, n^{12} - 70541948902 \, n^{11} - 584755678670 \, n^{10} - 3320352008678 \, n^{9} - 12387742331156 \, n^{8} - 29831329883498 \, n^{7} - 47515360712818 \, n^{6} - 63415337704074 \, n^{5} - 100090782258342 \, n^{4} - 108932284314786 \, n^{3} + 40336285445190 \, n^{2} + 205709680838814 \, n + 120109233244809\right)} β^{20} - 10 \, {\left(17823 \, n^{16} + 1080426 \, n^{15} - 16151310 \, n^{14} - 1840505718 \, n^{13} - 42203939746 \, n^{12} - 575992592910 \, n^{11} - 4823052535990 \, n^{10} - 24953512960590 \, n^{9} - 81120251298436 \, n^{8} - 166706912802690 \, n^{7} - 221920507776522 \, n^{6} - 247180746860514 \, n^{5} - 371871159920238 \, n^{4} - 411314116866138 \, n^{3} + 180210136660686 \, n^{2} + 852852335547174 \, n + 497447840904693\right)} β^{19} + 40 \, {\left(576 \, n^{16} + 516579 \, n^{15} + 12696657 \, n^{14} - 340955481 \, n^{13} - 16045171691 \, n^{12} - 282337445433 \, n^{11} - 2513126655923 \, n^{10} - 12560253812277 \, n^{9} - 37012780882895 \, n^{8} - 64989410072583 \, n^{7} - 69302419503741 \, n^{6} - 62692149471195 \, n^{5} - 95393839518609 \, n^{4} - 107487833167203 \, n^{3} + 57167935212447 \, n^{2} + 249868398299433 \, n + 145214189931339\right)} β^{18} + 6 \, {\left(49493 \, n^{16} - 1638938 \, n^{15} - 199074890 \, n^{14} - 1350078570 \, n^{13} + 103584628202 \, n^{12} + 2770626219838 \, n^{11} + 27588711264990 \, n^{10} + 139158443529870 \, n^{9} + 385311619394260 \, n^{8} + 580186644105010 \, n^{7} + 453155460212034 \, n^{6} + 302483246804226 \, n^{5} + 554965839087270 \, n^{4} + 617936698153770 \, n^{3} - 426102219630294 \, n^{2} - 1674280239096486 \, n - 963276863929785\right)} β^{17} - 2 \, {\left(171369 \, n^{16} + 9607446 \, n^{15} - 515088690 \, n^{14} - 17640010890 \, n^{13} + 111722127362 \, n^{12} + 9209867713422 \, n^{11} + 109593309047030 \, n^{10} + 580620043157070 \, n^{9} + 1568297833342004 \, n^{8} + 2059273059801090 \, n^{7} + 968679621130314 \, n^{6} + 235424404534242 \, n^{5} + 1290184794375630 \, n^{4} + 1291070230411482 \, n^{3} - 1294477202248974 \, n^{2} - 4360396150891302 \, n - 2457569360646765\right)} β^{16} - 10 \, {\left(4425 \, n^{16} - 3446730 \, n^{15} - 12209970 \, n^{14} + 4452626646 \, n^{13} + 38676189250 \, n^{12} - 1479374982994 \, n^{11} - 23442952578698 \, n^{10} - 135870849395026 \, n^{9} - 372488733012812 \, n^{8} - 443832157505950 \, n^{7} - 71001011352246 \, n^{6} + 123061174945026 \, n^{5} - 186152819264370 \, n^{4} - 142701120076230 \, n^{3} + 240573638966130 \, n^{2} + 656053036310010 \, n + 357225975188019\right)} β^{15} + 30 \, {\left(12619 \, n^{16} - 524078 \, n^{15} - 40777430 \, n^{14} + 859131026 \, n^{13} + 27485003686 \, n^{12} - 247131756614 \, n^{11} - 6708920963102 \, n^{10} - 44529457817574 \, n^{9} - 128974440917348 \, n^{8} - 148695951101386 \, n^{7} + 12942138150046 \, n^{6} + 95524028661174 \, n^{5} - 40167271304118 \, n^{4} - 23425928268354 \, n^{3} + 67670485851990 \, n^{2} + 142723574697246 \, n + 73832386199337\right)} β^{14} - 30 \, {\left(8279 \, n^{16} + 482690 \, n^{15} - 41824198 \, n^{14} - 159058814 \, n^{13} + 28069314534 \, n^{12} - 12430610006 \, n^{11} - 4535306423694 \, n^{10} - 36550289084086 \, n^{9} - 116274625561708 \, n^{8} - 139854867361978 \, n^{7} + 28538415605838 \, n^{6} + 131692743867014 \, n^{5} - 15776890188694 \, n^{4} - 17090087348722 \, n^{3} + 49759771054086 \, n^{2} + 80995179932462 \, n + 38958379064517\right)} β^{13} - 6 \, {\left(13747 \, n^{16} - 3889502 \, n^{15} + 71154730 \, n^{14} + 3845236290 \, n^{13} - 90220656730 \, n^{12} - 540627757430 \, n^{11} + 11557377435170 \, n^{10} + 123768775385930 \, n^{9} + 448986414768108 \, n^{8} + 602513100375078 \, n^{7} - 103085362448098 \, n^{6} - 685669106494138 \, n^{5} - 56186730867190 \, n^{4} + 95301738747694 \, n^{3} - 146280495945322 \, n^{2} - 201165694416722 \, n - 87281008654415\right)} β^{12} + 6 \, {\left(31101 \, n^{16} - 1735010 \, n^{15} - 50338250 \, n^{14} + 3664511230 \, n^{13} - 34726522630 \, n^{12} - 565815765322 \, n^{11} + 3963552198334 \, n^{10} + 67930603404790 \, n^{9} + 292120436522004 \, n^{8} + 459054540247450 \, n^{7} - 7446179318782 \, n^{6} - 559475582985606 \, n^{5} - 162430960960170 \, n^{4} + 87790812706962 \, n^{3} - 55896812088822 \, n^{2} - 87685568823534 \, n - 33297352711905\right)} β^{11} - 5 \, {\left(14745 \, n^{16} + 546906 \, n^{15} - 90421590 \, n^{14} + 2365074186 \, n^{13} - 4570949650 \, n^{12} - 402220009662 \, n^{11} + 609051885602 \, n^{10} + 35274910308306 \, n^{9} + 188381090862416 \, n^{8} + 357846736424718 \, n^{7} + 79225650216990 \, n^{6} - 424289129032098 \, n^{5} - 233933686817070 \, n^{4} + 57880218502614 \, n^{3} - 935245831914 \, n^{2} - 38373552635322 \, n - 13220411395497\right)} β^{10} - 20 \, {\left(1125 \, n^{16} - 274038 \, n^{15} + 13118580 \, n^{14} - 187040538 \, n^{13} - 1212867548 \, n^{12} + 38819451018 \, n^{11} + 101597838508 \, n^{10} - 2873741804490 \, n^{9} - 20412455587634 \, n^{8} - 47973006107154 \, n^{7} - 24814861632180 \, n^{6} + 49672226055618 \, n^{5} + 46513051495908 \, n^{4} - 1365083050242 \, n^{3} - 4723407767916 \, n^{2} + 2271208796706 \, n + 975966135237\right)} β^{9} + 60 \, {\left(501 \, n^{16} - 46818 \, n^{15} + 1393494 \, n^{14} - 8619778 \, n^{13} - 268087430 \, n^{12} + 3118755382 \, n^{11} + 25453817054 \, n^{10} - 214087529738 \, n^{9} - 2306681259580 \, n^{8} - 6869314995430 \, n^{7} - 5955183130526 \, n^{6} + 5114546833530 \, n^{5} + 8714745595542 \, n^{4} + 1661499856146 \, n^{3} - 1046194467222 \, n^{2} - 69466739694 \, n + 78147544887\right)} β^{8} - 32 \, {\left(324 \, n^{16} - 21609 \, n^{15} + 420840 \, n^{14} + 2169345 \, n^{13} - 149989910 \, n^{12} + 645951159 \, n^{11} + 16462260556 \, n^{10} - 45355410855 \, n^{9} - 1097951355554 \, n^{8} - 4290885084483 \, n^{7} - 5515573773648 \, n^{6} + 1087365113115 \, n^{5} + 6400394050710 \, n^{4} + 2928955458933 \, n^{3} - 449140649508 \, n^{2} - 302198199285 \, n + 7879568670\right)} β^{7} + 16 \, {\left(81 \, n^{16} - 4374 \, n^{15} + 28710 \, n^{14} + 2361930 \, n^{13} - 44817190 \, n^{12} - 122061006 \, n^{11} + 6547423790 \, n^{10} + 7553791410 \, n^{9} - 389096942596 \, n^{8} - 2127479278722 \, n^{7} - 3856435425198 \, n^{6} - 1210995759138 \, n^{5} + 3201396403350 \, n^{4} + 2812589489382 \, n^{3} + 313818720858 \, n^{2} - 237278234202 \, n - 31915086525\right)} β^{6} + 3840 \, {\left(27 \, n^{14} - 1134 \, n^{13} + 8211 \, n^{12} + 233500 \, n^{11} - 2809473 \, n^{10} - 19006106 \, n^{9} + 174291159 \, n^{8} + 1539893992 \, n^{7} + 3907408641 \, n^{6} + 3122915646 \, n^{5} - 1469167959 \, n^{4} - 3278454468 \, n^{3} - 1239208539 \, n^{2} + 65724810 \, n + 60784173\right)} β^{5} + 307200 \, {\left(9 \, n^{12} - 270 \, n^{11} + 834 \, n^{10} + 34374 \, n^{9} - 88457 \, n^{8} - 2122588 \, n^{7} - 7817556 \, n^{6} - 10528004 \, n^{5} - 2756585 \, n^{4} + 5718090 \, n^{3} + 4764018 \, n^{2} + 934622 \, n - 66039\right)} β^{4} + 9830400 \, {\left(3 \, n^{10} - 54 \, n^{9} - 159 \, n^{8} + 3840 \, n^{7} + 23046 \, n^{6} + 48004 \, n^{5} + 39498 \, n^{4} + 464 \, n^{3} - 18233 \, n^{2} - 9246 \, n - 1147\right)} β^{3} + 23592960 \, {\left(5 \, n^{8} - 30 \, n^{7} - 426 \, n^{6} - 1414 \, n^{5} - 2080 \, n^{4} - 1370 \, n^{3} - 150 \, n^{2} + 254 \, n + 91\right)} β^{2} + 125829120 \, {\left(n^{6} + 6 \, n^{5} + 15 \, n^{4} + 20 \, n^{3} + 15 \, n^{2} + 6 \, n + 1\right)} β}{11796480 \, {\left({\left(n^{6} + 18 \, n^{5} + 135 \, n^{4} + 540 \, n^{3} + 1215 \, n^{2} + 1458 \, n + 729\right)} β^{21} - 21 \, {\left(n^{6} + 18 \, n^{5} + 135 \, n^{4} + 540 \, n^{3} + 1215 \, n^{2} + 1458 \, n + 729\right)} β^{20} + 210 \, {\left(n^{6} + 18 \, n^{5} + 135 \, n^{4} + 540 \, n^{3} + 1215 \, n^{2} + 1458 \, n + 729\right)} β^{19} - 1330 \, {\left(n^{6} + 18 \, n^{5} + 135 \, n^{4} + 540 \, n^{3} + 1215 \, n^{2} + 1458 \, n + 729\right)} β^{18} + 5985 \, {\left(n^{6} + 18 \, n^{5} + 135 \, n^{4} + 540 \, n^{3} + 1215 \, n^{2} + 1458 \, n + 729\right)} β^{17} - 20349 \, {\left(n^{6} + 18 \, n^{5} + 135 \, n^{4} + 540 \, n^{3} + 1215 \, n^{2} + 1458 \, n + 729\right)} β^{16} + 54264 \, {\left(n^{6} + 18 \, n^{5} + 135 \, n^{4} + 540 \, n^{3} + 1215 \, n^{2} + 1458 \, n + 729\right)} β^{15} - 116280 \, {\left(n^{6} + 18 \, n^{5} + 135 \, n^{4} + 540 \, n^{3} + 1215 \, n^{2} + 1458 \, n + 729\right)} β^{14} + 203490 \, {\left(n^{6} + 18 \, n^{5} + 135 \, n^{4} + 540 \, n^{3} + 1215 \, n^{2} + 1458 \, n + 729\right)} β^{13} - 293930 \, {\left(n^{6} + 18 \, n^{5} + 135 \, n^{4} + 540 \, n^{3} + 1215 \, n^{2} + 1458 \, n + 729\right)} β^{12} + 352716 \, {\left(n^{6} + 18 \, n^{5} + 135 \, n^{4} + 540 \, n^{3} + 1215 \, n^{2} + 1458 \, n + 729\right)} β^{11} - 352716 \, {\left(n^{6} + 18 \, n^{5} + 135 \, n^{4} + 540 \, n^{3} + 1215 \, n^{2} + 1458 \, n + 729\right)} β^{10} + 293930 \, {\left(n^{6} + 18 \, n^{5} + 135 \, n^{4} + 540 \, n^{3} + 1215 \, n^{2} + 1458 \, n + 729\right)} β^{9} - 203490 \, {\left(n^{6} + 18 \, n^{5} + 135 \, n^{4} + 540 \, n^{3} + 1215 \, n^{2} + 1458 \, n + 729\right)} β^{8} + 116280 \, {\left(n^{6} + 18 \, n^{5} + 135 \, n^{4} + 540 \, n^{3} + 1215 \, n^{2} + 1458 \, n + 729\right)} β^{7} - 54264 \, {\left(n^{6} + 18 \, n^{5} + 135 \, n^{4} + 540 \, n^{3} + 1215 \, n^{2} + 1458 \, n + 729\right)} β^{6} - n^{6} + 20349 \, {\left(n^{6} + 18 \, n^{5} + 135 \, n^{4} + 540 \, n^{3} + 1215 \, n^{2} + 1458 \, n + 729\right)} β^{5} - 18 \, n^{5} - 5985 \, {\left(n^{6} + 18 \, n^{5} + 135 \, n^{4} + 540 \, n^{3} + 1215 \, n^{2} + 1458 \, n + 729\right)} β^{4} - 135 \, n^{4} + 1330 \, {\left(n^{6} + 18 \, n^{5} + 135 \, n^{4} + 540 \, n^{3} + 1215 \, n^{2} + 1458 \, n + 729\right)} β^{3} - 540 \, n^{3} - 210 \, {\left(n^{6} + 18 \, n^{5} + 135 \, n^{4} + 540 \, n^{3} + 1215 \, n^{2} + 1458 \, n + 729\right)} β^{2} - 1215 \, n^{2} + 21 \, {\left(n^{6} + 18 \, n^{5} + 135 \, n^{4} + 540 \, n^{3} + 1215 \, n^{2} + 1458 \, n + 729\right)} β - 1458 \, n - 729\right)}}$

    
    $\displaystyle $

    
    The denominators above are a bit ugly. Let us factor them. The
expressions \(R_i\) above equal the \(N_i/D_i\) computed below.

    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
\prompt{In}{incolor}{23}{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{k}{def} \PY{n+nf}{simplify\PYZus{}R}\PY{p}{(}\PY{n}{h}\PY{p}{)}\PY{p}{:}
    \PY{n}{R} \PY{o}{=} \PY{n}{compute\PYZus{}R}\PY{p}{(}\PY{n}{h}\PY{p}{)}
    \PY{n}{N}\PY{p}{,} \PY{n}{D} \PY{o}{=} \PY{p}{\PYZob{}}\PY{p}{\PYZcb{}}\PY{p}{,} \PY{p}{\PYZob{}}\PY{p}{\PYZcb{}}
    \PY{k}{for} \PY{n}{j} \PY{o+ow}{in} \PY{n}{R}\PY{o}{.}\PY{n}{keys}\PY{p}{(}\PY{p}{)}\PY{p}{:}
        \PY{n}{N}\PY{p}{[}\PY{n}{j}\PY{p}{]} \PY{o}{=} \PY{n}{R}\PY{p}{[}\PY{n}{j}\PY{p}{]}\PY{o}{.}\PY{n}{numerator}\PY{p}{(}\PY{p}{)}\PY{o}{.}\PY{n}{simplify\PYZus{}full}\PY{p}{(}\PY{p}{)}
        \PY{n}{D}\PY{p}{[}\PY{n}{j}\PY{p}{]} \PY{o}{=} \PY{n}{R}\PY{p}{[}\PY{n}{j}\PY{p}{]}\PY{o}{.}\PY{n}{denominator}\PY{p}{(}\PY{p}{)}\PY{o}{.}\PY{n}{factor}\PY{p}{(}\PY{p}{)}
    \PY{k}{return} \PY{n}{N}\PY{p}{,} \PY{n}{D}

\PY{n}{display\PYZus{}table}\PY{p}{(}\PY{l+m+mi}{6}\PY{p}{,} \PY{n}{simplify\PYZus{}R}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{N,D}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
    ...
    $\displaystyle N_1 = 2 \, n β$

    
    $\displaystyle $

    
    $\displaystyle N_2 = {\left(n^{4} + 8 \, n^{3} + 12 \, n^{2}\right)} β^{3} + 16 \, n^{2} β + {\left(n^{4} - 12 \, n^{3} - 20 \, n^{2} + 16 \, n\right)} β^{2}$

    
    $\displaystyle $

    
    $\displaystyle N_3 = {\left(3 \, n^{7} + 40 \, n^{6} + 256 \, n^{5} + 752 \, n^{4} + 976 \, n^{3} + 448 \, n^{2}\right)} β^{6} + 3 \, {\left(n^{7} - 24 \, n^{6} - 320 \, n^{5} - 944 \, n^{4} - 784 \, n^{3} + 64 \, n^{2}\right)} β^{5} - {\left(3 \, n^{7} + 48 \, n^{6} - 1152 \, n^{5} - 4432 \, n^{4} - 2736 \, n^{3} + 2112 \, n^{2} - 512 \, n\right)} β^{4} - 512 \, n^{3} β - {\left(3 \, n^{7} - 72 \, n^{6} + 384 \, n^{5} + 3504 \, n^{4} + 2640 \, n^{3} - 3136 \, n^{2} + 512 \, n\right)} β^{3} - 96 \, {\left(n^{5} - 12 \, n^{4} - 20 \, n^{3} + 16 \, n^{2}\right)} β^{2}$
    ...
    $\displaystyle N_5 = {\left(125 \, n^{13} + 2800 \, n^{12} + 37120 \, n^{11} + 285600 \, n^{10} + 1670624 \, n^{9} + 6859136 \, n^{8} + 17773312 \, n^{7} + 31354368 \, n^{6} + 51780864 \, n^{5} + 87029760 \, n^{4} + 96595968 \, n^{3} + 44531712 \, n^{2}\right)} β^{15} - 10 \, {\left(25 \, n^{13} + 1440 \, n^{12} + 28608 \, n^{11} + 285216 \, n^{10} + 1871456 \, n^{9} + 7796096 \, n^{8} + 20023040 \, n^{7} + 33834496 \, n^{6} + 47487232 \, n^{5} + 66127872 \, n^{4} + 67203072 \, n^{3} + 29982720 \, n^{2}\right)} β^{14} - 5 \, {\left(75 \, n^{13} - 3360 \, n^{12} - 160768 \, n^{11} - 2341536 \, n^{10} - 18264032 \, n^{9} - 80038784 \, n^{8} - 204881664 \, n^{7} - 327990784 \, n^{6} - 394315008 \, n^{5} - 452732928 \, n^{4} - 414855168 \, n^{3} - 176259072 \, n^{2}\right)} β^{13} + 40 \, {\left(25 \, n^{13} + 650 \, n^{12} - 19984 \, n^{11} - 626400 \, n^{10} - 6422656 \, n^{9} - 30869696 \, n^{8} - 79586176 \, n^{7} - 119388672 \, n^{6} - 121497856 \, n^{5} - 114146816 \, n^{4} - 94132224 \, n^{3} - 37126144 \, n^{2}\right)} β^{12} + 2 \, {\left(125 \, n^{13} - 33000 \, n^{12} - 300480 \, n^{11} + 13559840 \, n^{10} + 229576800 \, n^{9} + 1277996160 \, n^{8} + 3377849600 \, n^{7} + 4709152256 \, n^{6} + 3908752640 \, n^{5} + 2947112960 \, n^{4} + 2276659200 \, n^{3} + 782991360 \, n^{2} + 786432 \, n\right)} β^{11} - 4 \, {\left(375 \, n^{13} - 3300 \, n^{12} - 521680 \, n^{11} + 1253088 \, n^{10} + 133303072 \, n^{9} + 932882944 \, n^{8} + 2600352000 \, n^{7} + 3365069312 \, n^{6} + 2100666112 \, n^{5} + 1193026560 \, n^{4} + 1033773056 \, n^{3} + 249790464 \, n^{2} + 2359296 \, n\right)} β^{10} + 10 \, {\left(25 \, n^{13} + 6440 \, n^{12} - 146592 \, n^{11} - 2460384 \, n^{10} + 38177248 \, n^{9} + 390940800 \, n^{8} + 1200015616 \, n^{7} + 1461399040 \, n^{6} + 573391104 \, n^{5} + 172298240 \, n^{4} + 343879680 \, n^{3} + 19726336 \, n^{2} + 2359296 \, n\right)} β^{9} + 40 \, {\left(25 \, n^{13} - 1170 \, n^{12} - 10904 \, n^{11} + 812448 \, n^{10} - 3133664 \, n^{9} - 72787136 \, n^{8} - 262529280 \, n^{7} - 313051648 \, n^{6} - 45544192 \, n^{5} + 32042496 \, n^{4} - 77772800 \, n^{3} + 9093120 \, n^{2} - 786432 \, n\right)} β^{8} - 5 \, {\left(75 \, n^{13} + 2400 \, n^{12} - 230144 \, n^{11} + 3613536 \, n^{10} + 7275552 \, n^{9} - 294892416 \, n^{8} - 1383759616 \, n^{7} - 1740717568 \, n^{6} + 124058368 \, n^{5} + 553179136 \, n^{4} - 549007360 \, n^{3} + 97812480 \, n^{2} - 4718592 \, n\right)} β^{7} - 2 \, {\left(125 \, n^{13} - 11000 \, n^{12} + 290400 \, n^{11} - 1828320 \, n^{10} - 27706400 \, n^{9} + 224830080 \, n^{8} + 1663512320 \, n^{7} + 2460141056 \, n^{6} - 463094528 \, n^{5} - 1304064000 \, n^{4} + 949800960 \, n^{3} - 155811840 \, n^{2} + 4718592 \, n\right)} β^{6} + 1572864 \, n^{5} β + {\left(125 \, n^{13} - 6000 \, n^{12} + 82880 \, n^{11} + 612640 \, n^{10} - 21678880 \, n^{9} + 49107840 \, n^{8} + 1092007680 \, n^{7} + 2176570880 \, n^{6} - 330535680 \, n^{5} - 1597687808 \, n^{4} + 894038016 \, n^{3} - 107118592 \, n^{2} + 1572864 \, n\right)} β^{5} + 320 \, {\left(25 \, n^{11} - 900 \, n^{10} + 8604 \, n^{9} + 40896 \, n^{8} - 661840 \, n^{7} - 2158144 \, n^{6} - 134592 \, n^{5} + 2002432 \, n^{4} - 783360 \, n^{3} + 49152 \, n^{2}\right)} β^{4} + 30720 \, {\left(5 \, n^{9} - 120 \, n^{8} + 496 \, n^{7} + 4400 \, n^{6} + 2288 \, n^{5} - 4928 \, n^{4} + 1024 \, n^{3}\right)} β^{3} + 983040 \, {\left(n^{7} - 12 \, n^{6} - 20 \, n^{5} + 16 \, n^{4}\right)} β^{2}$

    
    $\displaystyle $

    
    $\displaystyle N_6 = 3 \, {\left(27 \, n^{16} + 720 \, n^{15} + 11580 \, n^{14} + 109360 \, n^{13} + 871264 \, n^{12} + 4422464 \, n^{11} + 18211200 \, n^{10} + 72760320 \, n^{9} + 193960704 \, n^{8} + 215339008 \, n^{7} + 1530880 \, n^{6} + 422809600 \, n^{5} + 2180792320 \, n^{4} + 3052453888 \, n^{3} + 1422458880 \, n^{2}\right)} β^{21} - 45 \, {\left(9 \, n^{16} + 396 \, n^{15} + 8468 \, n^{14} + 100160 \, n^{13} + 887520 \, n^{12} + 4988480 \, n^{11} + 21535360 \, n^{10} + 78964224 \, n^{9} + 195127552 \, n^{8} + 232442880 \, n^{7} + 85873664 \, n^{6} + 409133056 \, n^{5} + 1702035456 \, n^{4} + 2302296064 \, n^{3} + 1058734080 \, n^{2}\right)} β^{20} + 15 \, {\left(27 \, n^{16} + 3456 \, n^{15} + 113388 \, n^{14} + 1770624 \, n^{13} + 18183616 \, n^{12} + 114519488 \, n^{11} + 519663232 \, n^{10} + 1806197248 \, n^{9} + 4194460416 \, n^{8} + 5207277568 \, n^{7} + 3130989568 \, n^{6} + 8268963840 \, n^{5} + 27879890944 \, n^{4} + 36105240576 \, n^{3} + 16297295872 \, n^{2}\right)} β^{19} + 15 \, {\left(81 \, n^{16} - 2556 \, n^{15} - 247356 \, n^{14} - 5796976 \, n^{13} - 73275104 \, n^{12} - 529198464 \, n^{11} - 2549325440 \, n^{10} - 8605595648 \, n^{9} - 18997456640 \, n^{8} - 23989793792 \, n^{7} - 17776065536 \, n^{6} - 34193707008 \, n^{5} - 94281023488 \, n^{4} - 115696041984 \, n^{3} - 50922913792 \, n^{2}\right)} β^{18} - 15 \, {\left(189 \, n^{16} + 7776 \, n^{15} - 188364 \, n^{14} - 11061584 \, n^{13} - 192172288 \, n^{12} - 1654980928 \, n^{11} - 8604588928 \, n^{10} - 28799224320 \, n^{9} - 61038143232 \, n^{8} - 76753438720 \, n^{7} - 62297730048 \, n^{6} - 96928272384 \, n^{5} - 221119668224 \, n^{4} - 254231724032 \, n^{3} - 108229885952 \, n^{2}\right)} β^{17} - {\left(81 \, n^{16} - 273780 \, n^{15} - 4734540 \, n^{14} + 155914560 \, n^{13} + 5047692064 \, n^{12} + 55544578176 \, n^{11} + 319339999360 \, n^{10} + 1080838251520 \, n^{9} + 2219287655680 \, n^{8} + 2725433396224 \, n^{7} + 2256904102912 \, n^{6} + 2991881420800 \, n^{5} + 5725616373760 \, n^{4} + 6089370501120 \, n^{3} + 2483021283328 \, n^{2} - 7864320 \, n\right)} β^{16} + 5 \, {\left(1053 \, n^{16} - 19440 \, n^{15} - 2697516 \, n^{14} - 9072864 \, n^{13} + 1120867168 \, n^{12} + 18236402240 \, n^{11} + 120125914752 \, n^{10} + 419774910464 \, n^{9} + 842682510592 \, n^{8} + 992195094528 \, n^{7} + 793247667200 \, n^{6} + 923757469696 \, n^{5} + 1508339810304 \, n^{4} + 1460139212800 \, n^{3} + 564111540224 \, n^{2} - 15728640 \, n\right)} β^{15} - 15 \, {\left(243 \, n^{16} + 21708 \, n^{15} - 704532 \, n^{14} - 22131824 \, n^{13} + 185134400 \, n^{12} + 7328492672 \, n^{11} + 58423281536 \, n^{10} + 215855523328 \, n^{9} + 428138472192 \, n^{8} + 474752633856 \, n^{7} + 346649713664 \, n^{6} + 363261890560 \, n^{5} + 518470262784 \, n^{4} + 445522247680 \, n^{3} + 161564590080 \, n^{2} - 23592960 \, n\right)} β^{14} - 15 \, {\left(243 \, n^{16} - 27216 \, n^{15} - 313332 \, n^{14} + 27892464 \, n^{13} + 156883744 \, n^{12} - 6281173056 \, n^{11} - 66682041472 \, n^{10} - 268200886784 \, n^{9} - 532861781248 \, n^{8} - 547238606848 \, n^{7} - 338874864640 \, n^{6} - 329735196672 \, n^{5} - 429572161536 \, n^{4} - 311505141760 \, n^{3} - 106301947904 \, n^{2} + 62914560 \, n\right)} β^{13} + 15 \, {\left(351 \, n^{16} - 684 \, n^{15} - 1018164 \, n^{14} + 12856192 \, n^{13} + 408033440 \, n^{12} - 3386628672 \, n^{11} - 59373196160 \, n^{10} - 270093982720 \, n^{9} - 547832925440 \, n^{8} - 514272969728 \, n^{7} - 236822774784 \, n^{6} - 228175691776 \, n^{5} - 298000039936 \, n^{4} - 161128824832 \, n^{3} - 54480142336 \, n^{2} + 110100480 \, n\right)} β^{12} - 3 \, {\left(27 \, n^{16} + 99360 \, n^{15} - 3431700 \, n^{14} - 37330320 \, n^{13} + 2029080160 \, n^{12} - 2356892480 \, n^{11} - 202820316800 \, n^{10} - 1101495073280 \, n^{9} - 2341979831552 \, n^{8} - 2002426669056 \, n^{7} - 491001959424 \, n^{6} - 571608453120 \, n^{5} - 932483645440 \, n^{4} - 264444329984 \, n^{3} - 113935056896 \, n^{2} + 660602880 \, n\right)} β^{11} - 15 \, {\left(189 \, n^{16} - 13068 \, n^{15} - 45324 \, n^{14} + 15170304 \, n^{13} - 230242112 \, n^{12} - 993385344 \, n^{11} + 20423992960 \, n^{10} + 144315370496 \, n^{9} + 333475704064 \, n^{8} + 263927174144 \, n^{7} - 6999899136 \, n^{6} + 31685459968 \, n^{5} + 115658956800 \, n^{4} - 182910976 \, n^{3} + 8713535488 \, n^{2} - 110100480 \, n\right)} β^{10} + 15 \, {\left(81 \, n^{16} + 1152 \, n^{15} - 344700 \, n^{14} + 10284624 \, n^{13} - 65960448 \, n^{12} - 1019277248 \, n^{11} + 6844616576 \, n^{10} + 74566093824 \, n^{9} + 196548624640 \, n^{8} + 151028224000 \, n^{7} - 48703761408 \, n^{6} - 9399668736 \, n^{5} + 72986124288 \, n^{4} - 14485241856 \, n^{3} + 3467837440 \, n^{2} - 62914560 \, n\right)} β^{9} + 15 \, {\left(27 \, n^{16} - 4860 \, n^{15} + 220284 \, n^{14} - 3494368 \, n^{13} - 2888928 \, n^{12} + 513060224 \, n^{11} - 992639360 \, n^{10} - 29406003712 \, n^{9} - 94450300160 \, n^{8} - 76577940480 \, n^{7} + 43197242368 \, n^{6} + 20186234880 \, n^{5} - 43084185600 \, n^{4} + 11497930752 \, n^{3} - 1362886656 \, n^{2} + 23592960 \, n\right)} β^{8} - 5 \, {\left(81 \, n^{16} - 6480 \, n^{15} + 180900 \, n^{14} - 1286928 \, n^{13} - 28054592 \, n^{12} + 436269888 \, n^{11} + 931823488 \, n^{10} - 24993155072 \, n^{9} - 107971307264 \, n^{8} - 102679175168 \, n^{7} + 68282217472 \, n^{6} + 48371863552 \, n^{5} - 63700951040 \, n^{4} + 16259334144 \, n^{3} - 1280638976 \, n^{2} + 15728640 \, n\right)} β^{7} + 7864320 \, n^{6} β + {\left(81 \, n^{16} - 4860 \, n^{15} + 77220 \, n^{14} + 1082400 \, n^{13} - 44194240 \, n^{12} + 272426688 \, n^{11} + 3158817920 \, n^{10} - 22256197120 \, n^{9} - 155822553856 \, n^{8} - 193758555136 \, n^{7} + 115630343168 \, n^{6} + 129054064640 \, n^{5} - 119758888960 \, n^{4} + 24954912768 \, n^{3} - 1280770048 \, n^{2} + 7864320 \, n\right)} β^{6} + 240 \, {\left(27 \, n^{14} - 1296 \, n^{13} + 18072 \, n^{12} + 64240 \, n^{11} - 3011632 \, n^{10} + 6091264 \, n^{9} + 131435968 \, n^{8} + 238880768 \, n^{7} - 92251136 \, n^{6} - 200732672 \, n^{5} + 131652608 \, n^{4} - 19263488 \, n^{3} + 491520 \, n^{2}\right)} β^{5} + 19200 \, {\left(9 \, n^{12} - 324 \, n^{11} + 3024 \, n^{10} + 12888 \, n^{9} - 200560 \, n^{8} - 627200 \, n^{7} + 32128 \, n^{6} + 626560 \, n^{5} - 269312 \, n^{4} + 20480 \, n^{3}\right)} β^{4} + 614400 \, {\left(3 \, n^{10} - 72 \, n^{9} + 288 \, n^{8} + 2520 \, n^{7} + 1200 \, n^{6} - 2912 \, n^{5} + 640 \, n^{4}\right)} β^{3} + 7372800 \, {\left(n^{8} - 12 \, n^{7} - 20 \, n^{6} + 16 \, n^{5}\right)} β^{2}$

    
    $\displaystyle $

    
    $\displaystyle D_1 = n + 2$

    
    $\displaystyle $

    
    $\displaystyle D_2 = 8 \, {\left(n + 2\right)}^{2} {\left(β - 1\right)}$

    
    $\displaystyle $

    
    $\displaystyle D_3 = 192 \, {\left(n + 2\right)}^{3} {\left(β - 1\right)}^{3}$

    
    $\displaystyle $

    
    $\displaystyle D_4 = 384 \, {\left(n + 2\right)}^{4} {\left(β - 1\right)}^{6}$

    
    $\displaystyle $

    
    $\displaystyle D_5 = 245760 \, {\left(n + 2\right)}^{5} {\left(β - 1\right)}^{10}$

    
    $\displaystyle $

    
    $\displaystyle D_6 = 737280 \, {\left(n + 2\right)}^{6} {\left(β - 1\right)}^{15}$
    ...
    $\displaystyle N_1 = {\left(n - 1\right)} β^{2} - 2 \, {\left(n + 1\right)} β$

    
    $\displaystyle $

    
    $\displaystyle N_2 = 2 \, {\left(n^{3} + 3 \, n^{2} - n - 3\right)} β^{5} - {\left(n^{4} + 14 \, n^{3} + 20 \, n^{2} - 38 \, n + 3\right)} β^{4} + 4 \, {\left(5 \, n^{3} + 13 \, n^{2} - 13 \, n - 5\right)} β^{3} + {\left(n^{4} - 10 \, n^{3} - 64 \, n^{2} - 22 \, n + 31\right)} β^{2} + 16 \, {\left(n^{2} + 2 \, n + 1\right)} β$

    
    $\displaystyle $

    
    $\displaystyle N_3 = -8 \, {\left(n^{6} - 47 \, n^{4} - 168 \, n^{3} - 125 \, n^{2} + 168 \, n + 171\right)} β^{9} - 3 \, {\left(n^{7} + 9 \, n^{6} + 193 \, n^{5} + 1137 \, n^{4} + 2011 \, n^{3} - 93 \, n^{2} - 2205 \, n - 1053\right)} β^{8} + 2 \, {\left(3 \, n^{7} + 105 \, n^{6} + 1527 \, n^{5} + 6149 \, n^{4} + 5449 \, n^{3} - 6789 \, n^{2} - 4419 \, n - 2025\right)} β^{7} + 2 \, {\left(3 \, n^{7} - 121 \, n^{6} - 3109 \, n^{5} - 13225 \, n^{4} - 8287 \, n^{3} + 20573 \, n^{2} + 1665 \, n + 2501\right)} β^{6} - 12 \, {\left(n^{7} + 9 \, n^{6} - 507 \, n^{5} - 3067 \, n^{4} - 2845 \, n^{3} + 5099 \, n^{2} + 1303 \, n + 7\right)} β^{5} - {\left(3 \, n^{7} - 309 \, n^{6} + 2499 \, n^{5} + 30275 \, n^{4} + 51089 \, n^{3} - 37383 \, n^{2} - 39255 \, n + 1273\right)} β^{4} + 2 \, {\left(3 \, n^{7} - 63 \, n^{6} + 15 \, n^{5} + 6261 \, n^{4} + 19449 \, n^{3} + 3251 \, n^{2} - 13323 \, n - 3305\right)} β^{3} + 192 \, {\left(n^{5} - 9 \, n^{4} - 66 \, n^{3} - 78 \, n^{2} + n + 23\right)} β^{2} + 1024 \, {\left(n^{3} + 3 \, n^{2} + 3 \, n + 1\right)} β$

    
    $\displaystyle $

    
    $\displaystyle N_4 = -8 \, {\left(11 \, n^{8} + 116 \, n^{7} + 228 \, n^{6} - 1796 \, n^{5} - 10310 \, n^{4} - 18516 \, n^{3} - 4428 \, n^{2} + 20196 \, n + 14499\right)} β^{14} - {\left(n^{10} + 12 \, n^{9} - 469 \, n^{8} - 2328 \, n^{7} + 22418 \, n^{6} + 214080 \, n^{5} + 682750 \, n^{4} + 881304 \, n^{3} - 30051 \, n^{2} - 1093068 \, n - 674649\right)} β^{13} + 3 \, {\left(3 \, n^{10} + 84 \, n^{9} + 585 \, n^{8} + 9560 \, n^{7} + 91606 \, n^{6} + 394368 \, n^{5} + 819242 \, n^{4} + 688552 \, n^{3} - 317193 \, n^{2} - 1092564 \, n - 594243\right)} β^{12} - {\left(13 \, n^{10} + 860 \, n^{9} + 14999 \, n^{8} + 197128 \, n^{7} + 1252842 \, n^{6} + 3744192 \, n^{5} + 5029430 \, n^{4} + 1810168 \, n^{3} - 3117767 \, n^{2} - 5967388 \, n - 2964477\right)} β^{11} - {\left(19 \, n^{10} - 764 \, n^{9} - 35911 \, n^{8} - 573928 \, n^{7} - 3398154 \, n^{6} - 8254176 \, n^{5} - 6412150 \, n^{4} + 2498408 \, n^{3} + 4733383 \, n^{2} + 7909468 \, n + 3533805\right)} β^{10} + 3 \, {\left(15 \, n^{10} + 332 \, n^{9} - 11291 \, n^{8} - 318504 \, n^{7} - 2079666 \, n^{6} - 4750288 \, n^{5} - 1892958 \, n^{4} + 3957992 \, n^{3} + 1328627 \, n^{2} + 2718148 \, n + 1047593\right)} β^{9} + {\left(3 \, n^{10} - 2268 \, n^{9} - 6231 \, n^{8} + 953624 \, n^{7} + 8050390 \, n^{6} + 20040544 \, n^{5} + 5772522 \, n^{4} - 23541400 \, n^{3} - 3763465 \, n^{2} - 5284100 \, n - 2219619\right)} β^{8} - {\left(47 \, n^{10} - 876 \, n^{9} - 43203 \, n^{8} + 521176 \, n^{7} + 7230158 \, n^{6} + 22156160 \, n^{5} + 9872338 \, n^{4} - 29252824 \, n^{3} - 8590829 \, n^{2} - 452372 \, n - 1243167\right)} β^{7} + 3 \, {\left(5 \, n^{10} + 332 \, n^{9} - 12945 \, n^{8} + 25032 \, n^{7} + 1439322 \, n^{6} + 5993568 \, n^{5} + 4909222 \, n^{4} - 7329608 \, n^{3} - 4949551 \, n^{2} + 360404 \, n - 42565\right)} β^{6} + 8 \, {\left(2 \, n^{10} - 125 \, n^{9} + 1764 \, n^{8} + 9912 \, n^{7} - 194132 \, n^{6} - 1241890 \, n^{5} - 1739272 \, n^{4} + 945424 \, n^{3} + 1722994 \, n^{2} + 188375 \, n - 61692\right)} β^{5} - 8 \, {\left(n^{10} - 32 \, n^{9} + 129 \, n^{8} + 5728 \, n^{7} - 32110 \, n^{6} - 425072 \, n^{5} - 975446 \, n^{4} - 174464 \, n^{3} + 775853 \, n^{2} + 348080 \, n - 14187\right)} β^{4} - 384 \, {\left(n^{8} - 20 \, n^{7} - 15 \, n^{6} + 1590 \, n^{5} + 6253 \, n^{4} + 5648 \, n^{3} - 1777 \, n^{2} - 3378 \, n - 622\right)} β^{3} - 1536 \, {\left(3 \, n^{6} - 24 \, n^{5} - 217 \, n^{4} - 416 \, n^{3} - 231 \, n^{2} + 56 \, n + 61\right)} β^{2} - 12288 \, {\left(n^{4} + 4 \, n^{3} + 6 \, n^{2} + 4 \, n + 1\right)} β$

    
    $\displaystyle $

    
    $\displaystyle N_5 = 64 \, {\left(15 \, n^{11} - 125 \, n^{10} - 3955 \, n^{9} - 29351 \, n^{8} - 87322 \, n^{7} + 83758 \, n^{6} + 1589546 \, n^{5} + 5298306 \, n^{4} + 7044219 \, n^{3} - 31617 \, n^{2} - 8542503 \, n - 5320971\right)} β^{20} - 5 \, {\left(n^{13} - 33 \, n^{12} + 454 \, n^{11} - 47678 \, n^{10} - 698749 \, n^{9} - 3407051 \, n^{8} - 2633180 \, n^{7} + 49673260 \, n^{6} + 285021367 \, n^{5} + 748360857 \, n^{4} + 878591286 \, n^{3} - 97103502 \, n^{2} - 1160281179 \, n - 697475853\right)} β^{19} + 10 \, {\left(15 \, n^{13} + 273 \, n^{12} + 4442 \, n^{11} - 117538 \, n^{10} - 1423635 \, n^{9} - 2420581 \, n^{8} + 33627548 \, n^{7} + 251754900 \, n^{6} + 899705657 \, n^{5} + 1898124023 \, n^{4} + 1932533226 \, n^{3} - 488350674 \, n^{2} - 2864447253 \, n - 1658990403\right)} β^{18} - 5 \, {\left(155 \, n^{13} + 5861 \, n^{12} + 112482 \, n^{11} + 205110 \, n^{10} + 1995729 \, n^{9} + 74874167 \, n^{8} + 630873292 \, n^{7} + 2635298084 \, n^{6} + 6847638477 \, n^{5} + 11688739267 \, n^{4} + 10109315634 \, n^{3} - 4583016250 \, n^{2} - 17589935769 \, n - 9816106239\right)} β^{17} + {\left(1185 \, n^{13} + 97595 \, n^{12} + 2709590 \, n^{11} + 27145850 \, n^{10} + 309651315 \, n^{9} + 2807185945 \, n^{8} + 14579139140 \, n^{7} + 44573263932 \, n^{6} + 88184221623 \, n^{5} + 120983054205 \, n^{4} + 86875793030 \, n^{3} - 66401841110 \, n^{2} - 189753335019 \, n - 102187087281\right)} β^{16} + 4 \, {\left(285 \, n^{13} - 28790 \, n^{12} - 1611030 \, n^{11} - 27371808 \, n^{10} - 350717421 \, n^{9} - 2665561102 \, n^{8} - 11245882804 \, n^{7} - 27180189776 \, n^{6} - 40622099245 \, n^{5} - 43456381586 \, n^{4} - 25483159062 \, n^{3} + 33746624176 \, n^{2} + 77112072413 \, n + 40174305750\right)} β^{15} - 5 \, {\left(1023 \, n^{13} + 18365 \, n^{12} - 1406326 \, n^{11} - 46027914 \, n^{10} - 727046643 \, n^{9} - 5439877521 \, n^{8} - 20683993476 \, n^{7} - 41121782044 \, n^{6} - 43624857879 \, n^{5} - 32616941045 \, n^{4} - 16461794854 \, n^{3} + 41848821190 \, n^{2} + 78960495659 \, n + 39914391465\right)} β^{14} + 20 \, {\left(152 \, n^{13} + 20057 \, n^{12} + 67332 \, n^{11} - 13449846 \, n^{10} - 313884260 \, n^{9} - 2538210241 \, n^{8} - 9365403000 \, n^{7} - 16008970068 \, n^{6} - 10423950928 \, n^{5} - 2522706969 \, n^{4} - 2384793612 \, n^{3} + 13050413930 \, n^{2} + 20473125532 \, n + 10047741921\right)} β^{13} + 10 \, {\left(561 \, n^{13} - 33781 \, n^{12} - 1406122 \, n^{11} + 10989946 \, n^{10} + 747822851 \, n^{9} + 7167408361 \, n^{8} + 27452739780 \, n^{7} + 43194534076 \, n^{6} + 12888364391 \, n^{5} - 15920740115 \, n^{4} + 2488230150 \, n^{3} - 26245443414 \, n^{2} - 35197105083 \, n - 16585361601\right)} β^{12} - {\left(7885 \, n^{13} + 163515 \, n^{12} - 16944530 \, n^{11} - 169861590 \, n^{10} + 5960025415 \, n^{9} + 77190794825 \, n^{8} + 327622643860 \, n^{7} + 519080338076 \, n^{6} + 40790346827 \, n^{5} - 408298019875 \, n^{4} + 1345399710 \, n^{3} - 194828466150 \, n^{2} - 256478387967 \, n - 112097376705\right)} β^{11} - 8 \, {\left(30 \, n^{13} - 59795 \, n^{12} + 723800 \, n^{11} + 42410962 \, n^{10} - 334923122 \, n^{9} - 7848195077 \, n^{8} - 39434388864 \, n^{7} - 68845436452 \, n^{6} - 3003491334 \, n^{5} + 73649888755 \, n^{4} + 8325346536 \, n^{3} + 9862436082 \, n^{2} + 19710176922 \, n + 7749682437\right)} β^{10} + 5 \, {\left(1149 \, n^{13} - 51893 \, n^{12} - 1322418 \, n^{11} + 57648458 \, n^{10} + 10334103 \, n^{9} - 7483238599 \, n^{8} - 48057080108 \, n^{7} - 99320062884 \, n^{6} - 17974458469 \, n^{5} + 119228897101 \, n^{4} + 35444180862 \, n^{3} - 2851871430 \, n^{2} + 14314931121 \, n + 5726123343\right)} β^{9} - 5 \, {\left(543 \, n^{13} + 16069 \, n^{12} - 1829462 \, n^{11} + 26631430 \, n^{10} + 197617997 \, n^{9} - 3051309977 \, n^{8} - 28130179140 \, n^{7} - 72552011068 \, n^{6} - 32545596279 \, n^{5} + 84920414595 \, n^{4} + 50229891450 \, n^{3} - 5793726122 \, n^{2} + 2077493547 \, n + 2206667313\right)} β^{8} - 10 \, {\left(101 \, n^{13} - 15539 \, n^{12} + 485830 \, n^{11} - 2589154 \, n^{10} - 70354025 \, n^{9} + 350249607 \, n^{8} + 6075408900 \, n^{7} + 20490919092 \, n^{6} + 16806251715 \, n^{5} - 19567936501 \, n^{4} - 22217736490 \, n^{3} - 888136370 \, n^{2} + 1368878241 \, n - 231496191\right)} β^{7} + {\left(1125 \, n^{13} - 68705 \, n^{12} + 1187150 \, n^{11} + 4544210 \, n^{10} - 249726305 \, n^{9} + 1692165 \, n^{8} + 18178337940 \, n^{7} + 85293412684 \, n^{6} + 111271980947 \, n^{5} - 40690337415 \, n^{4} - 124365732930 \, n^{3} - 34193241790 \, n^{2} + 8904491977 \, n + 1210609539\right)} β^{6} - 2 \, {\left(125 \, n^{13} - 5375 \, n^{12} + 32710 \, n^{11} + 1660550 \, n^{10} - 21915825 \, n^{9} - 128446765 \, n^{8} + 1671395140 \, n^{7} + 12309687140 \, n^{6} + 24151783755 \, n^{5} + 5689274007 \, n^{4} - 20219918186 \, n^{3} - 13159877962 \, n^{2} - 296554679 \, n + 572531445\right)} β^{5} - 640 \, {\left(25 \, n^{11} - 775 \, n^{10} + 2911 \, n^{9} + 105991 \, n^{8} - 418134 \, n^{7} - 7006134 \, n^{6} - 20778418 \, n^{5} - 16935490 \, n^{4} + 7672173 \, n^{3} + 14623405 \, n^{2} + 4084259 \, n - 224181\right)} β^{4} - 61440 \, {\left(5 \, n^{9} - 95 \, n^{8} - 172 \, n^{7} + 7012 \, n^{6} + 34342 \, n^{5} + 52046 \, n^{4} + 18340 \, n^{3} - 19788 \, n^{2} - 15651 \, n - 2311\right)} β^{3} - 1966080 \, {\left(n^{7} - 7 \, n^{6} - 79 \, n^{5} - 207 \, n^{4} - 213 \, n^{3} - 61 \, n^{2} + 35 \, n + 19\right)} β^{2} - 3145728 \, {\left(n^{5} + 5 \, n^{4} + 10 \, n^{3} + 10 \, n^{2} + 5 \, n + 1\right)} β$

    
    $\displaystyle $

    
    $\displaystyle N_6 = 3072 \, {\left(20 \, n^{13} + 293 \, n^{12} - 866 \, n^{11} - 30992 \, n^{10} - 189010 \, n^{9} - 525083 \, n^{8} - 507540 \, n^{7} + 3450824 \, n^{6} + 25620304 \, n^{5} + 78387135 \, n^{4} + 100992726 \, n^{3} - 5166072 \, n^{2} - 125915634 \, n - 76116105\right)} β^{27} - 3 \, {\left(n^{16} - 142 \, n^{15} - 4590 \, n^{14} + 162690 \, n^{13} + 1154262 \, n^{12} - 51981318 \, n^{11} - 684707350 \, n^{10} - 3166843670 \, n^{9} - 5239145688 \, n^{8} + 9232267734 \, n^{7} + 97395886806 \, n^{6} + 456752073798 \, n^{5} + 1254181048650 \, n^{4} + 1561891504446 \, n^{3} - 129494685906 \, n^{2} - 2024657183538 \, n - 1216159546185\right)} β^{26} + 30 \, {\left(9 \, n^{16} + 54 \, n^{15} - 3326 \, n^{14} + 27246 \, n^{13} - 1679954 \, n^{12} - 63933986 \, n^{11} - 596492630 \, n^{10} - 2051694250 \, n^{9} + 158643008 \, n^{8} + 23751208962 \, n^{7} + 108419490694 \, n^{6} + 374705460330 \, n^{5} + 926141669874 \, n^{4} + 1113333008490 \, n^{3} - 133514595378 \, n^{2} - 1509674076846 \, n - 900607032297\right)} β^{25} - 30 \, {\left(103 \, n^{16} + 2922 \, n^{15} + 32690 \, n^{14} + 348234 \, n^{13} - 13522562 \, n^{12} - 357283214 \, n^{11} - 2665819894 \, n^{10} - 4962204174 \, n^{9} + 31636443372 \, n^{8} + 215894626942 \, n^{7} + 703935660086 \, n^{6} + 1924896249950 \, n^{5} + 4297676389426 \, n^{4} + 4990427847206 \, n^{3} - 808470514674 \, n^{2} - 7125899587866 \, n - 4222098668547\right)} β^{24} + 30 \, {\left(479 \, n^{16} + 22634 \, n^{15} + 482818 \, n^{14} + 6152490 \, n^{13} - 12943474 \, n^{12} - 894212302 \, n^{11} - 4807971366 \, n^{10} + 17531010066 \, n^{9} + 268121544748 \, n^{8} + 1179912618494 \, n^{7} + 3091483423398 \, n^{6} + 6940588103550 \, n^{5} + 14056933189794 \, n^{4} + 15823541920998 \, n^{3} - 3300876946818 \, n^{2} - 23960685615930 \, n - 14110840779579\right)} β^{23} - 6 \, {\left(4943 \, n^{16} + 404762 \, n^{15} + 12735250 \, n^{14} + 213638490 \, n^{13} + 1390001118 \, n^{12} + 4449325218 \, n^{11} + 76192714794 \, n^{10} + 1047372297730 \, n^{9} + 6581592572444 \, n^{8} + 22589459866638 \, n^{7} + 49657535904726 \, n^{6} + 93285695979022 \, n^{5} + 172298057166610 \, n^{4} + 189396166164662 \, n^{3} - 49040323686930 \, n^{2} - 306328202097642 \, n - 179569612991835\right)} β^{22} + 2 \, {\left(2757 \, n^{16} + 2104230 \, n^{15} + 109745070 \, n^{14} + 2487285990 \, n^{13} + 27592214002 \, n^{12} + 244381502238 \, n^{11} + 2176651842262 \, n^{10} + 15184182300990 \, n^{9} + 68926873932796 \, n^{8} + 195917146130994 \, n^{7} + 366848495204586 \, n^{6} + 581097224745138 \, n^{5} + 986091114413310 \, n^{4} + 1070671014866058 \, n^{3} - 334530092144238 \, n^{2} - 1863371746220118 \, n - 1089285437926065\right)} β^{21} + 30 \, {\left(3291 \, n^{16} - 31118 \, n^{15} - 11553030 \, n^{14} - 403699886 \, n^{13} - 6297407146 \, n^{12} - 70541948902 \, n^{11} - 584755678670 \, n^{10} - 3320352008678 \, n^{9} - 12387742331156 \, n^{8} - 29831329883498 \, n^{7} - 47515360712818 \, n^{6} - 63415337704074 \, n^{5} - 100090782258342 \, n^{4} - 108932284314786 \, n^{3} + 40336285445190 \, n^{2} + 205709680838814 \, n + 120109233244809\right)} β^{20} - 10 \, {\left(17823 \, n^{16} + 1080426 \, n^{15} - 16151310 \, n^{14} - 1840505718 \, n^{13} - 42203939746 \, n^{12} - 575992592910 \, n^{11} - 4823052535990 \, n^{10} - 24953512960590 \, n^{9} - 81120251298436 \, n^{8} - 166706912802690 \, n^{7} - 221920507776522 \, n^{6} - 247180746860514 \, n^{5} - 371871159920238 \, n^{4} - 411314116866138 \, n^{3} + 180210136660686 \, n^{2} + 852852335547174 \, n + 497447840904693\right)} β^{19} + 40 \, {\left(576 \, n^{16} + 516579 \, n^{15} + 12696657 \, n^{14} - 340955481 \, n^{13} - 16045171691 \, n^{12} - 282337445433 \, n^{11} - 2513126655923 \, n^{10} - 12560253812277 \, n^{9} - 37012780882895 \, n^{8} - 64989410072583 \, n^{7} - 69302419503741 \, n^{6} - 62692149471195 \, n^{5} - 95393839518609 \, n^{4} - 107487833167203 \, n^{3} + 57167935212447 \, n^{2} + 249868398299433 \, n + 145214189931339\right)} β^{18} + 6 \, {\left(49493 \, n^{16} - 1638938 \, n^{15} - 199074890 \, n^{14} - 1350078570 \, n^{13} + 103584628202 \, n^{12} + 2770626219838 \, n^{11} + 27588711264990 \, n^{10} + 139158443529870 \, n^{9} + 385311619394260 \, n^{8} + 580186644105010 \, n^{7} + 453155460212034 \, n^{6} + 302483246804226 \, n^{5} + 554965839087270 \, n^{4} + 617936698153770 \, n^{3} - 426102219630294 \, n^{2} - 1674280239096486 \, n - 963276863929785\right)} β^{17} - 2 \, {\left(171369 \, n^{16} + 9607446 \, n^{15} - 515088690 \, n^{14} - 17640010890 \, n^{13} + 111722127362 \, n^{12} + 9209867713422 \, n^{11} + 109593309047030 \, n^{10} + 580620043157070 \, n^{9} + 1568297833342004 \, n^{8} + 2059273059801090 \, n^{7} + 968679621130314 \, n^{6} + 235424404534242 \, n^{5} + 1290184794375630 \, n^{4} + 1291070230411482 \, n^{3} - 1294477202248974 \, n^{2} - 4360396150891302 \, n - 2457569360646765\right)} β^{16} - 10 \, {\left(4425 \, n^{16} - 3446730 \, n^{15} - 12209970 \, n^{14} + 4452626646 \, n^{13} + 38676189250 \, n^{12} - 1479374982994 \, n^{11} - 23442952578698 \, n^{10} - 135870849395026 \, n^{9} - 372488733012812 \, n^{8} - 443832157505950 \, n^{7} - 71001011352246 \, n^{6} + 123061174945026 \, n^{5} - 186152819264370 \, n^{4} - 142701120076230 \, n^{3} + 240573638966130 \, n^{2} + 656053036310010 \, n + 357225975188019\right)} β^{15} + 30 \, {\left(12619 \, n^{16} - 524078 \, n^{15} - 40777430 \, n^{14} + 859131026 \, n^{13} + 27485003686 \, n^{12} - 247131756614 \, n^{11} - 6708920963102 \, n^{10} - 44529457817574 \, n^{9} - 128974440917348 \, n^{8} - 148695951101386 \, n^{7} + 12942138150046 \, n^{6} + 95524028661174 \, n^{5} - 40167271304118 \, n^{4} - 23425928268354 \, n^{3} + 67670485851990 \, n^{2} + 142723574697246 \, n + 73832386199337\right)} β^{14} - 30 \, {\left(8279 \, n^{16} + 482690 \, n^{15} - 41824198 \, n^{14} - 159058814 \, n^{13} + 28069314534 \, n^{12} - 12430610006 \, n^{11} - 4535306423694 \, n^{10} - 36550289084086 \, n^{9} - 116274625561708 \, n^{8} - 139854867361978 \, n^{7} + 28538415605838 \, n^{6} + 131692743867014 \, n^{5} - 15776890188694 \, n^{4} - 17090087348722 \, n^{3} + 49759771054086 \, n^{2} + 80995179932462 \, n + 38958379064517\right)} β^{13} - 6 \, {\left(13747 \, n^{16} - 3889502 \, n^{15} + 71154730 \, n^{14} + 3845236290 \, n^{13} - 90220656730 \, n^{12} - 540627757430 \, n^{11} + 11557377435170 \, n^{10} + 123768775385930 \, n^{9} + 448986414768108 \, n^{8} + 602513100375078 \, n^{7} - 103085362448098 \, n^{6} - 685669106494138 \, n^{5} - 56186730867190 \, n^{4} + 95301738747694 \, n^{3} - 146280495945322 \, n^{2} - 201165694416722 \, n - 87281008654415\right)} β^{12} + 6 \, {\left(31101 \, n^{16} - 1735010 \, n^{15} - 50338250 \, n^{14} + 3664511230 \, n^{13} - 34726522630 \, n^{12} - 565815765322 \, n^{11} + 3963552198334 \, n^{10} + 67930603404790 \, n^{9} + 292120436522004 \, n^{8} + 459054540247450 \, n^{7} - 7446179318782 \, n^{6} - 559475582985606 \, n^{5} - 162430960960170 \, n^{4} + 87790812706962 \, n^{3} - 55896812088822 \, n^{2} - 87685568823534 \, n - 33297352711905\right)} β^{11} - 5 \, {\left(14745 \, n^{16} + 546906 \, n^{15} - 90421590 \, n^{14} + 2365074186 \, n^{13} - 4570949650 \, n^{12} - 402220009662 \, n^{11} + 609051885602 \, n^{10} + 35274910308306 \, n^{9} + 188381090862416 \, n^{8} + 357846736424718 \, n^{7} + 79225650216990 \, n^{6} - 424289129032098 \, n^{5} - 233933686817070 \, n^{4} + 57880218502614 \, n^{3} - 935245831914 \, n^{2} - 38373552635322 \, n - 13220411395497\right)} β^{10} - 20 \, {\left(1125 \, n^{16} - 274038 \, n^{15} + 13118580 \, n^{14} - 187040538 \, n^{13} - 1212867548 \, n^{12} + 38819451018 \, n^{11} + 101597838508 \, n^{10} - 2873741804490 \, n^{9} - 20412455587634 \, n^{8} - 47973006107154 \, n^{7} - 24814861632180 \, n^{6} + 49672226055618 \, n^{5} + 46513051495908 \, n^{4} - 1365083050242 \, n^{3} - 4723407767916 \, n^{2} + 2271208796706 \, n + 975966135237\right)} β^{9} + 60 \, {\left(501 \, n^{16} - 46818 \, n^{15} + 1393494 \, n^{14} - 8619778 \, n^{13} - 268087430 \, n^{12} + 3118755382 \, n^{11} + 25453817054 \, n^{10} - 214087529738 \, n^{9} - 2306681259580 \, n^{8} - 6869314995430 \, n^{7} - 5955183130526 \, n^{6} + 5114546833530 \, n^{5} + 8714745595542 \, n^{4} + 1661499856146 \, n^{3} - 1046194467222 \, n^{2} - 69466739694 \, n + 78147544887\right)} β^{8} - 32 \, {\left(324 \, n^{16} - 21609 \, n^{15} + 420840 \, n^{14} + 2169345 \, n^{13} - 149989910 \, n^{12} + 645951159 \, n^{11} + 16462260556 \, n^{10} - 45355410855 \, n^{9} - 1097951355554 \, n^{8} - 4290885084483 \, n^{7} - 5515573773648 \, n^{6} + 1087365113115 \, n^{5} + 6400394050710 \, n^{4} + 2928955458933 \, n^{3} - 449140649508 \, n^{2} - 302198199285 \, n + 7879568670\right)} β^{7} + 16 \, {\left(81 \, n^{16} - 4374 \, n^{15} + 28710 \, n^{14} + 2361930 \, n^{13} - 44817190 \, n^{12} - 122061006 \, n^{11} + 6547423790 \, n^{10} + 7553791410 \, n^{9} - 389096942596 \, n^{8} - 2127479278722 \, n^{7} - 3856435425198 \, n^{6} - 1210995759138 \, n^{5} + 3201396403350 \, n^{4} + 2812589489382 \, n^{3} + 313818720858 \, n^{2} - 237278234202 \, n - 31915086525\right)} β^{6} + 3840 \, {\left(27 \, n^{14} - 1134 \, n^{13} + 8211 \, n^{12} + 233500 \, n^{11} - 2809473 \, n^{10} - 19006106 \, n^{9} + 174291159 \, n^{8} + 1539893992 \, n^{7} + 3907408641 \, n^{6} + 3122915646 \, n^{5} - 1469167959 \, n^{4} - 3278454468 \, n^{3} - 1239208539 \, n^{2} + 65724810 \, n + 60784173\right)} β^{5} + 307200 \, {\left(9 \, n^{12} - 270 \, n^{11} + 834 \, n^{10} + 34374 \, n^{9} - 88457 \, n^{8} - 2122588 \, n^{7} - 7817556 \, n^{6} - 10528004 \, n^{5} - 2756585 \, n^{4} + 5718090 \, n^{3} + 4764018 \, n^{2} + 934622 \, n - 66039\right)} β^{4} + 9830400 \, {\left(3 \, n^{10} - 54 \, n^{9} - 159 \, n^{8} + 3840 \, n^{7} + 23046 \, n^{6} + 48004 \, n^{5} + 39498 \, n^{4} + 464 \, n^{3} - 18233 \, n^{2} - 9246 \, n - 1147\right)} β^{3} + 23592960 \, {\left(5 \, n^{8} - 30 \, n^{7} - 426 \, n^{6} - 1414 \, n^{5} - 2080 \, n^{4} - 1370 \, n^{3} - 150 \, n^{2} + 254 \, n + 91\right)} β^{2} + 125829120 \, {\left(n^{6} + 6 \, n^{5} + 15 \, n^{4} + 20 \, n^{3} + 15 \, n^{2} + 6 \, n + 1\right)} β$

    
    $\displaystyle $

    
    $\displaystyle D_1 = {\left(n + 3\right)} {\left(β - 1\right)}$

    
    $\displaystyle $

    
    $\displaystyle D_2 = 8 \, {\left(n + 3\right)}^{2} {\left(β - 1\right)}^{3}$

    
    $\displaystyle $

    
    $\displaystyle D_3 = 384 \, {\left(n + 3\right)}^{3} {\left(β - 1\right)}^{6}$

    
    $\displaystyle $

    
    $\displaystyle D_4 = 3072 \, {\left(n + 3\right)}^{4} {\left(β - 1\right)}^{10}$

    
    $\displaystyle $

    
    $\displaystyle D_5 = 491520 \, {\left(n + 3\right)}^{5} {\left(β - 1\right)}^{15}$

    
    $\displaystyle $

    
    $\displaystyle D_6 = 11796480 \, {\left(n + 3\right)}^{6} {\left(β - 1\right)}^{21}$
